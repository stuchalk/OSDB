...
class SchemaBehavior extends ModelBehavior
{
    ...
    public function restriction(Model $model,$idx,$res,$out,$parent="")
    {
        ...
        if(isset($res['enumeration']))
        {
            if(!isset($res['enumeration'][0])) {
                $res['enumeration'] = array($res['enumeration']);
            }
        ...
        if(isset($res['sequence']))
        {
            if(!isset($res['sequence'][0])) {
                $res['sequence'] = array($res['sequence']);
            }
        ...
        if(isset($res['minLength']))
        {
            if(!isset($res['minLength'][0])) {
                $res['minLength'] = array($res['minLength']);
            }
        ...
        if(isset($res['maxLength']))
        {
            if(!isset($res['maxLength'][0])) {
                $res['maxLength'] = array($res['maxLength']);
            }
        ...
        if(isset($res['minInclusive']))
        {
            if(!isset($res['minInclusive'][0])) {
                $res['minInclusive'] = array($res['minInclusive']);
            }
    ...
    public function enumeration(Model $model,$opt,$out,$parent="")
    {
        ...
        if(isset($opt['annotation'])) { $out[]="// ".$opt['annotation']['documentation']; }
    ...
    public function union(Model $model,$idx,$unn,$out,$parent="")
    {
        ...
        if(isset($unn['annotation'])) { $out[]="// ".$unn['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($unn['@'.$type])) { $attrs[]="'".$unn['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function minLength(Model $model,$idx,$mil,$out,$parent="")
    {
        ...
        if(isset($mil['annotation'])) { $out[]="// ".$mil['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($mil['@'.$type])) { $attrs[]="'".$mil['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function maxLength(Model $model,$idx,$mxl,$out,$parent="")
    {
        ...
        if(isset($mxl['annotation'])) { $out[]="// ".$mxl['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($mxl['@'.$type])) { $attrs[]="'".$mxl['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function minInclusive(Model $model,$idx,$mii,$out,$parent="")
    {
        ...
        if(isset($mii['annotation'])) { $out[]="// ".$mii['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($mii['@'.$type])) { $attrs[]="'".$mii['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function key(Model $model,$idx,$key,$out,$parent="")
    {
        ...
        if(isset($key['annotation'])) { $out[]="// ".$key['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($key['@'.$type])) { $attrs[]="'".$type."'=>'".$key['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function keyref(Model $model,$idx,$ref,$out,$parent="")
    {
        ...
        if(isset($ref['annotation'])) { $out[]="// ".$ref['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($ref['@'.$type])) { $attrs[]="'".$type."'=>'".$ref['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function unique(Model $model,$idx,$uni,$out,$parent="")
    {
        ...
        if(isset($uni['annotation'])) { $out[]="// ".$uni['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($uni['@'.$type])) { $attrs[]="'".$type."'=>'".$uni['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function selector(Model $model,$sel,$out,$parent="")
    {
        ...
        if(isset($sel['annotation'])) { $out[]="// ".$sel['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($sel['@'.$type])) { $attrs[]="'".$type."'=>'".$sel['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function field(Model $model,$fld,$out,$parent="")
    {
        ...
        if(isset($fld['annotation'])) { $out[]="// ".$fld['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($fld['@'.$type])) { $attrs[]="'".$type."'=>'".$fld['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function sequence(Model $model,$idx,$seq,$out,$parent="")
    {
        ...
        if(isset($seq['annotation'])) { $out[]="// ".$seq['annotation']['documentation']; }
    ...
    public function choice(Model $model,$idx,$cho,$out,$parent="")
    {
        ...
        if(isset($cho['annotation'])) { $out[]="// ".$cho['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($cho['@'.$type])) { $attrs[]="'".$type."'=>'".$cho['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function element(Model $model,$idx,$ele,$out,$parent="")
    {
        ...
        if(isset($ele['annotation'])) { $out[]="// ".$ele['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($ele['@'.$type])) { $attrs[]="'".$type."'=>'".$ele['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
    ...
    public function simpleContent(Model $model,$idx,$sim,$out,$parent="")
    {
        ...
        foreach($types as $type)
        {
            if(isset($sim['@'.$type])) { $attrs[]="'".$type."'=>'".$sim['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
        ...
        {
            if(!isset($sim['extension'][0])) { $sim['extension'] = array($sim['extension']); }
    ...
    public function complexContent(Model $model,$idx,$con,$out,$parent="")
    {
        ...
        if(isset($con['annotation'])) { $out[]="// ".$con['annotation']['documentation']; }
        ...
        if(isset($con['extension']))
        {
            if(!isset($con['extension'][0])) {
                $con['extension'] = array($con['extension']);
            }
        ...
        if(isset($con['restriction']))
        {
            if(!isset($con['restriction'][0])) {
                $con['restriction'] = array($con['restriction']);
            }
    ...
    public function extension(Model $model,$idx,$ext,$out,$parent="")
    {
        ...
        if(isset($ext['annotation'])) { $out[]="// ".$ext['annotation']['documentation']; }
        ...
        foreach($types as $type)
        {
            if(isset($ext['@'.$type])) { $attrs[]="'".$type."'=>'".$ext['@'.$type]."'"; }
        }
        $str.=implode(",",$attrs);
        $str.="];";
        $out[]=$str;
        ...
        if(isset($ext['attributeGroup']))
        {
            if(!isset($ext['attributeGroup'][0])) {
                $ext['attributeGroup'] = array($ext['attributeGroup']);
            }
    ...
    public function attributeGroup(Model $model,$idx,$grp,$out,$parent="")
    {
        ...
        if(isset($grp['annotation'])) { $out[]="// ".$grp['annotation']['documentation']; }
