...
f,g)!==a});if(v.nodeType)return f.grep(g,function(g){return g===v!==a});if("string"===typeof v){if(Vc.test(v))return f.filter(v,g,a);v=f.filter(v,g)}return f.grep(g,function(g){return 0<=f.inArray(g,v)!==a})}function e(g,v){do g=g[v];while(g&&1!==g.nodeType);return g}function k(){y.addEventListener?(y.removeEventListener("DOMContentLoaded",s,!1),a.removeEventListener("load",s,!1)):(y.detachEvent("onreadystatechange",s),a.detachEvent("onload",s))}function s(){if(y.addEventListener||"load"===event.type||
"complete"===y.readyState)k(),f.ready()}function t(g,v,a){if(void 0===a&&1===g.nodeType)if(a="data-"+v.replace(Wc,"-$1").toLowerCase(),a=g.getAttribute(a),"string"===typeof a){try{a="true"===a?!0:"false"===a?!1:"null"===a?null:+a+""===a?+a:Xc.test(a)?f.parseJSON(a):a}catch(I){}f.data(g,v,a)}else a=void 0;return a}function u(g){for(var a in g)if(!("data"===a&&f.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function b(g,a,p,I){if(f.acceptData(g)){var b=f.expando,c=g.nodeType,d=c?f.cache:g,n=
c?g[b]:g[b]&&b;if(n&&d[n]&&(I||d[n].data)||!(void 0===p&&"string"===typeof a)){n||(n=c?g[b]=j.pop()||f.guid++:b);d[n]||(d[n]=c?{}:{toJSON:f.noop});if("object"===typeof a||"function"===typeof a)I?d[n]=f.extend(d[n],a):d[n].data=f.extend(d[n].data,a);g=d[n];I||(g.data||(g.data={}),g=g.data);void 0!==p&&(g[f.camelCase(a)]=p);"string"===typeof a?(p=g[a],null==p&&(p=g[f.camelCase(a)])):p=g;return p}}}function c(g,a,p){if(f.acceptData(g)){var I,b,c=g.nodeType,j=c?f.cache:g,d=c?g[f.expando]:f.expando;if(j[d]){if(a&&
(I=p?j[d]:j[d].data)){f.isArray(a)?a=a.concat(f.map(a,f.camelCase)):a in I?a=[a]:(a=f.camelCase(a),a=a in I?[a]:a.split(" "));for(b=a.length;b--;)delete I[a[b]];if(p?!u(I):!f.isEmptyObject(I))return}if(!p&&(delete j[d].data,!u(j[d])))return;c?f.cleanData([g],!0):w.deleteExpando||j!=j.window?delete j[d]:j[d]=null}}}function d(){return!0}function q(){return!1}function L(){try{return y.activeElement}catch(g){}}function U(g){var a=mc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function C(g,a){var p,I,b=0,c=typeof g.getElementsByTagName!==la?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==la?g.querySelectorAll(a||"*"):void 0;if(!c){c=[];for(p=g.childNodes||g;null!=(I=p[b]);b++)!a||f.nodeName(I,a)?c.push(I):f.merge(c,C(I,a))}return void 0===a||a&&f.nodeName(g,a)?f.merge([g],c):c}function rb(g){Mb.test(g.type)&&(g.defaultChecked=g.checked)}function Ya(g,a){return f.nodeName(g,"table")&&f.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?g.getElementsByTagName("tbody")[0]||
g.appendChild(g.ownerDocument.createElement("tbody")):g}function Ca(g){g.type=(null!==f.find.attr(g,"type"))+"/"+g.type;return g}function V(g){var a=Yc.exec(g.type);a?g.type=a[1]:g.removeAttribute("type");return g}function P(g,a){for(var p,I=0;null!=(p=g[I]);I++)f._data(p,"globalEval",!a||f._data(a[I],"globalEval"))}function Da(g,a){if(1===a.nodeType&&f.hasData(g)){var p,I,b;I=f._data(g);var c=f._data(a,I),j=I.events;if(j)for(p in delete c.handle,c.events={},j){I=0;for(b=j[p].length;I<b;I++)f.event.add(a,
p,j[p][I])}c.data&&(c.data=f.extend({},c.data))}}function Oa(g,v){var p=f(v.createElement(g)).appendTo(v.body),b=a.getDefaultComputedStyle?a.getDefaultComputedStyle(p[0]).display:f.css(p[0],"display");p.detach();return b}function db(g){var a=y,p=nc[g];if(!p){p=Oa(g,a);if("none"===p||!p)eb=(eb||f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),a=(eb[0].contentWindow||eb[0].contentDocument).document,a.write(),a.close(),p=Oa(g,a),eb.detach();nc[g]=p}return p}function fb(g,
a){return{get:function(){var p=g();if(null!=p)if(p)delete this.get;else return(this.get=a).apply(this,arguments)}}}function gb(g,a){if(a in g)return a;for(var p=a.charAt(0).toUpperCase()+a.slice(1),b=a,f=oc.length;f--;)if(a=oc[f]+p,a in g)return a;return b}function ta(g,a){for(var p,b,c,j=[],d=0,n=g.length;d<n;d++)if(b=g[d],b.style)if(j[d]=f._data(b,"olddisplay"),p=b.style.display,a)!j[d]&&"none"===p&&(b.style.display=""),""===b.style.display&&hb(b)&&(j[d]=f._data(b,"olddisplay",db(b.nodeName)));
else if(!j[d]&&(c=hb(b),p&&"none"!==p||!c))f._data(b,"olddisplay",c?p:f.css(b,"display"));for(d=0;d<n;d++)if(b=g[d],b.style&&(!a||"none"===b.style.display||""===b.style.display))b.style.display=a?j[d]||"":"none";return g}function ma(g,a,p){return(g=Zc.exec(a))?Math.max(0,g[1]-(p||0))+(g[2]||"px"):a}function x(g,a,p,b,c){a=p===(b?"border":"content")?4:"width"===a?1:0;for(var j=0;4>a;a+=2)"margin"===p&&(j+=f.css(g,p+Pa[a],!0,c)),b?("content"===p&&(j-=f.css(g,"padding"+Pa[a],!0,c)),"margin"!==p&&(j-=
f.css(g,"border"+Pa[a]+"Width",!0,c))):(j+=f.css(g,"padding"+Pa[a],!0,c),"padding"!==p&&(j+=f.css(g,"border"+Pa[a]+"Width",!0,c)));return j}function W(g,a,p){var b=!0,c="width"===a?g.offsetWidth:g.offsetHeight,j=Qa(g),d=w.boxSizing()&&"border-box"===f.css(g,"boxSizing",!1,j);if(0>=c||null==c){c=Ra(g,a,j);if(0>c||null==c)c=g.style[a];if(sb.test(c))return c;b=d&&(w.boxSizingReliable()||c===g.style[a]);c=parseFloat(c)||0}return c+x(g,a,p||(d?"border":"content"),b,j)+"px"}function H(g,a,p,b,f){return new H.prototype.init(g,
a,p,b,f)}function ga(){setTimeout(function(){Za=void 0});return Za=f.now()}function N(g,a){var p,b={height:g},f=0;for(a=a?1:0;4>f;f+=2-a)p=Pa[f],b["margin"+p]=b["padding"+p]=g;a&&(b.opacity=b.width=g);return b}function ua(g,a,p){for(var b,f=(ib[a]||[]).concat(ib["*"]),c=0,j=f.length;c<j;c++)if(b=f[c].call(p,a,g))return b}function jb(g,a,p){var b,c,j=0,d=tb.length,n=f.Deferred().always(function(){delete e.elem}),e=function(){if(c)return!1;for(var a=Za||ga(),a=Math.max(0,r.startTime+r.duration-a),v=
...
!0;v<p;v++)r.tweens[v].run(1);a?n.resolveWith(g,[r,a]):n.rejectWith(g,[r,a]);return this}});a=r.props;p=r.opts.specialEasing;var h,q,l,k;for(b in a)if(h=f.camelCase(b),q=p[h],l=a[b],f.isArray(l)&&(q=l[1],l=a[b]=l[0]),b!==h&&(a[h]=l,delete a[b]),(k=f.cssHooks[h])&&"expand"in k)for(b in l=k.expand(l),delete a[h],l)b in a||(a[b]=l[b],p[b]=q);else p[h]=q;for(;j<d;j++)if(b=tb[j].call(r,g,a,r.opts))return b;f.map(a,ua,r);f.isFunction(r.opts.start)&&r.opts.start.call(g,r);f.fx.timer(f.extend(e,{elem:g,anim:r,
queue:r.opts.queue}));return r.progress(r.opts.progress).done(r.opts.done,r.opts.complete).fail(r.opts.fail).always(r.opts.always)}function kb(g){return function(a,p){"string"!==typeof a&&(p=a,a="*");var b,c=0,j=a.toLowerCase().match(va)||[];if(f.isFunction(p))for(;b=j[c++];)"+"===b.charAt(0)?(b=b.slice(1)||"*",(g[b]=g[b]||[]).unshift(p)):(g[b]=g[b]||[]).push(p)}}function ub(g,a,p,b){function c(n){var e;j[n]=!0;f.each(g[n]||[],function(g,f){var n=f(a,p,b);if("string"===typeof n&&!d&&!j[n])return a.dataTypes.unshift(n),
c(n),!1;if(d)return!(e=n)});return e}var j={},d=g===Nb;return c(a.dataTypes[0])||!j["*"]&&c("*")}function wa(g,a){var p,b,c=f.ajaxSettings.flatOptions||{};for(b in a)void 0!==a[b]&&((c[b]?g:p||(p={}))[b]=a[b]);p&&f.extend(!0,g,p);return g}function na(g,a,p,b){var c;if(f.isArray(a))f.each(a,function(a,v){p||ad.test(g)?b(g,v):na(g+"["+("object"===typeof v?a:"")+"]",v,p,b)});else if(!p&&"object"===f.type(a))for(c in a)na(g+"["+c+"]",a[c],p,b);else b(g,a)}function B(g){try{return g?new a.ActiveXObject("Microsoft.XMLHTTP"):
new a.XMLHttpRequest}catch(v){}}function X(){try{return new a.XMLHttpRequest}catch(g){}}function ca(g){return f.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var j=[],n=j.slice,r=j.concat,z=j.push,E=j.indexOf,O={},bd=O.toString,xa=O.hasOwnProperty,Ob="".trim,w={},f=function(g,a){return new f.fn.init(g,a)},cd=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,dd=/^-ms-/,ed=/-([\da-z])/gi,fd=function(g,a){return a.toUpperCase()};f.fn=f.prototype={jquery:"1.11.0",constructor:f,selector:"",length:0,
...
g.length,j=!p;f<c;f++)p=!a(g[f],f),p!==j&&b.push(g[f]);return b},map:function(g,a,p){var b,f=0,c=g.length,j=[];if(l(g))for(;f<c;f++)b=a(g[f],f,p),null!=b&&j.push(b);else for(f in g)b=a(g[f],f,p),null!=b&&j.push(b);return r.apply([],j)},guid:1,proxy:function(g,a){var p,b;"string"===typeof a&&(b=g[a],a=g,g=b);if(f.isFunction(g))return p=n.call(arguments,2),b=function(){return g.apply(a||this,p.concat(n.call(arguments)))},b.guid=g.guid=g.guid||f.guid++,b},now:function(){return+new Date},support:w});
f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){O["[object "+a+"]"]=a.toLowerCase()});var Pb=a,D=function(g,a,p,b){var f,c,j,d,n;(a?a.ownerDocument||a:Y)!==Q&&oa(a);a=a||Q;p=p||[];if(!g||"string"!==typeof g)return p;if(1!==(d=a.nodeType)&&9!==d)return[];if(Z&&!b){if(f=gd.exec(g))if(j=f[1])if(9===d)if((c=a.getElementById(j))&&c.parentNode){if(c.id===j)return p.push(c),p}else return p;else{if(a.ownerDocument&&(c=a.ownerDocument.getElementById(j))&&ra(a,
c)&&c.id===j)return p.push(c),p}else{if(f[2])return Ea.apply(p,a.getElementsByTagName(g)),p;if((j=f[3])&&G.getElementsByClassName&&a.getElementsByClassName)return Ea.apply(p,a.getElementsByClassName(j)),p}if(G.qsa&&(!R||!R.test(g))){c=f=K;j=a;n=9===d&&g;if(1===d&&"object"!==a.nodeName.toLowerCase()){d=sa(g);(f=a.getAttribute("id"))?c=f.replace(hd,"\\$&"):a.setAttribute("id",c);c="[id='"+c+"'] ";for(j=d.length;j--;)d[j]=c+vb(d[j]);j=Qb.test(g)&&ha(a.parentNode)||a;n=d.join(",")}if(n)try{return Ea.apply(p,
j.querySelectorAll(n)),p}catch(e){}finally{f||a.removeAttribute("id")}}}var r;a:{g=g.replace(wb,"$1");c=sa(g);if(!b&&1===c.length){f=c[0]=c[0].slice(0);if(2<f.length&&"ID"===(r=f[0]).type&&G.getById&&9===a.nodeType&&Z&&F.relative[f[1].type]){a=(F.find.ID(r.matches[0].replace(Fa,Ga),a)||[])[0];if(!a){r=p;break a}g=g.slice(f.shift().value.length)}for(d=xb.needsContext.test(g)?0:f.length;d--;){r=f[d];if(F.relative[j=r.type])break;if(j=F.find[j])if(b=j(r.matches[0].replace(Fa,Ga),Qb.test(f[0].type)&&
ha(a.parentNode)||a)){f.splice(d,1);g=b.length&&vb(f);if(!g){Ea.apply(p,b);r=p;break a}break}}}$a(g,c)(b,a,!Z,p,Qb.test(g)&&ha(a.parentNode)||a);r=p}return r},Rb=function(){function g(p,b){a.push(p+" ")>F.cacheLength&&delete g[a.shift()];return g[p+" "]=b}var a=[];return g},S=function(g){g[K]=!0;return g},pa=function(g){var a=Q.createElement("div");try{return!!g(a)}catch(p){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}},Sb=function(g,a){for(var p=g.split("|"),b=g.length;b--;)F.attrHandle[p[b]]=
a},pc=function(g,a){var p=a&&g,b=p&&1===g.nodeType&&1===a.nodeType&&(~a.sourceIndex||ia)-(~g.sourceIndex||ia);if(b)return b;if(p)for(;p=p.nextSibling;)if(p===a)return-1;return g?1:-1},id=function(g){return function(a){return"input"===a.nodeName.toLowerCase()&&a.type===g}},jd=function(g){return function(a){var p=a.nodeName.toLowerCase();return("input"===p||"button"===p)&&a.type===g}},Sa=function(g){return S(function(a){a=+a;return S(function(p,b){for(var f,c=g([],p.length,a),j=c.length;j--;)if(p[f=
c[j]])p[f]=!(b[f]=p[f])})})},ha=function(g){return g&&typeof g.getElementsByTagName!==T&&g},qc=function(){},sa=function(g,a){var p,b,f,c,j,d,n;if(j=Ha[g+" "])return a?0:j.slice(0);j=g;d=[];for(n=F.preFilter;j;){if(!p||(b=kd.exec(j)))b&&(j=j.slice(b[0].length)||j),d.push(f=[]);p=!1;if(b=ld.exec(j))p=b.shift(),f.push({value:p,type:b[0].replace(wb," ")}),j=j.slice(p.length);for(c in F.filter)if((b=xb[c].exec(j))&&(!n[c]||(b=n[c](b))))p=b.shift(),f.push({value:p,type:c,matches:b}),j=j.slice(p.length);
if(!p)break}return a?j.length:j?D.error(g):Ha(g,d).slice(0)},vb=function(g){for(var a=0,p=g.length,b="";a<p;a++)b+=g[a].value;return b},Tb=function(g,a,p){var b=a.dir,f=p&&"parentNode"===b,c=md++;return a.first?function(a,p,v){for(;a=a[b];)if(1===a.nodeType||f)return g(a,p,v)}:function(a,p,v){var j,d,n=[da,c];if(v)for(;a=a[b];){if((1===a.nodeType||f)&&g(a,p,v))return!0}else for(;a=a[b];)if(1===a.nodeType||f){d=a[K]||(a[K]={});if((j=d[b])&&j[0]===da&&j[1]===c)return n[2]=j[2];d[b]=n;if(n[2]=g(a,p,
v))return!0}}},Ub=function(g){return 1<g.length?function(a,p,b){for(var f=g.length;f--;)if(!g[f](a,p,b))return!1;return!0}:g[0]},Ta=function(g,a,p,b,f){for(var c,j=[],d=0,n=g.length,e=null!=a;d<n;d++)if(c=g[d])if(!p||p(c,b,f))j.push(c),e&&a.push(d);return j},Vb=function(g,a,p,b,f,c){b&&!b[K]&&(b=Vb(b));f&&!f[K]&&(f=Vb(f,c));return S(function(c,j,d,n){var e,r,Na=[],h=[],l=j.length,q;if(!(q=c)){q=a||"*";for(var k=d.nodeType?[d]:d,A=[],z=0,T=k.length;z<T;z++)D(q,k[z],A);q=A}q=g&&(c||!a)?Ta(q,Na,g,d,
n):q;k=p?f||(c?g:l||b)?[]:j:q;p&&p(q,k,d,n);if(b){e=Ta(k,h);b(e,[],d,n);for(d=e.length;d--;)if(r=e[d])k[h[d]]=!(q[h[d]]=r)}if(c){if(f||g){if(f){e=[];for(d=k.length;d--;)if(r=k[d])e.push(q[d]=r);f(null,k=[],e,n)}for(d=k.length;d--;)if((r=k[d])&&-1<(e=f?Ua.call(c,r):Na[d]))c[e]=!(j[e]=r)}}else k=Ta(k===j?k.splice(l,k.length):k),f?f(null,j,k,n):Ea.apply(j,k)})},Wb=function(g){var a,p,b,f=g.length,c=F.relative[g[0].type];p=c||F.relative[" "];for(var j=c?1:0,d=Tb(function(g){return g===a},p,!0),n=Tb(function(g){return-1<
Ua.call(a,g)},p,!0),e=[function(g,p,b){return!c&&(b||p!==ya)||((a=p).nodeType?d(g,p,b):n(g,p,b))}];j<f;j++)if(p=F.relative[g[j].type])e=[Tb(Ub(e),p)];else{p=F.filter[g[j].type].apply(null,g[j].matches);if(p[K]){for(b=++j;b<f&&!F.relative[g[b].type];b++);return Vb(1<j&&Ub(e),1<j&&vb(g.slice(0,j-1).concat({value:" "===g[j-2].type?"*":""})).replace(wb,"$1"),p,j<b&&Wb(g.slice(j,b)),b<f&&Wb(g=g.slice(b)),b<f&&vb(g))}e.push(p)}return Ub(e)},za,G,F,Ia,rc,$a,ya,qa,Aa,oa,Q,ja,Z,R,ea,Ja,ra,K="sizzle"+-new Date,
Y=Pb.document,da=0,md=0,sc=Rb(),Ha=Rb(),Ba=Rb(),A=function(g,a){g===a&&(Aa=!0);return 0},T="undefined",ia=-2147483648,fa={}.hasOwnProperty,M=[],aa=M.pop,nd=M.push,Ea=M.push,tc=M.slice,Ua=M.indexOf||function(g){for(var a=0,p=this.length;a<p;a++)if(this[a]===g)return a;return-1},uc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),vc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+uc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
...
function(g,a){for(var p=g.length,b=0;g[p++]=a[b++];);g.length=p-1}}}G=D.support={};rc=D.isXML=function(g){return(g=g&&(g.ownerDocument||g).documentElement)?"HTML"!==g.nodeName:!1};oa=D.setDocument=function(g){var a=g?g.ownerDocument||g:Y;g=a.defaultView;if(a===Q||9!==a.nodeType||!a.documentElement)return Q;Q=a;ja=a.documentElement;Z=!rc(a);g&&g!==g.top&&(g.addEventListener?g.addEventListener("unload",function(){oa()},!1):g.attachEvent&&g.attachEvent("onunload",function(){oa()}));G.attributes=pa(function(g){g.className=
"i";return!g.getAttribute("className")});G.getElementsByTagName=pa(function(g){g.appendChild(a.createComment(""));return!g.getElementsByTagName("*").length});G.getElementsByClassName=lb.test(a.getElementsByClassName)&&pa(function(g){g.innerHTML="<div class='a'></div><div class='a i'></div>";g.firstChild.className="i";return 2===g.getElementsByClassName("i").length});G.getById=pa(function(g){ja.appendChild(g).id=K;return!a.getElementsByName||!a.getElementsByName(K).length});G.getById?(F.find.ID=function(g,
...
v=[],f=0,c=a.getElementsByTagName(g);if("*"===g){for(;b=c[f++];)1===b.nodeType&&v.push(b);return v}return c};F.find.CLASS=G.getElementsByClassName&&function(g,a){if(typeof a.getElementsByClassName!==T&&Z)return a.getElementsByClassName(g)};ea=[];R=[];if(G.qsa=lb.test(a.querySelectorAll))pa(function(g){g.innerHTML="<select t=''><option selected=''></option></select>";g.querySelectorAll("[t^='']").length&&R.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");g.querySelectorAll("[selected]").length||R.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
g.querySelectorAll(":checked").length||R.push(":checked")}),pa(function(g){var b=a.createElement("input");b.setAttribute("type","hidden");g.appendChild(b).setAttribute("name","D");g.querySelectorAll("[name=d]").length&&R.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");g.querySelectorAll(":enabled").length||R.push(":enabled",":disabled");g.querySelectorAll("*,:x");R.push(",.*:")});(G.matchesSelector=lb.test(Ja=ja.webkitMatchesSelector||ja.mozMatchesSelector||ja.oMatchesSelector||ja.msMatchesSelector))&&
pa(function(g){G.disconnectedMatch=Ja.call(g,"div");Ja.call(g,"[s!='']:x");ea.push("!=",Xb)});R=R.length&&RegExp(R.join("|"));ea=ea.length&&RegExp(ea.join("|"));ra=(g=lb.test(ja.compareDocumentPosition))||lb.test(ja.contains)?function(g,a){var b=9===g.nodeType?g.documentElement:g,v=a&&a.parentNode;return g===v||!(!v||!(1===v.nodeType&&(b.contains?b.contains(v):g.compareDocumentPosition&&g.compareDocumentPosition(v)&16)))}:function(g,a){if(a)for(;a=a.parentNode;)if(a===g)return!0;return!1};A=g?function(g,
b){if(g===b)return Aa=!0,0;var f=!g.compareDocumentPosition-!b.compareDocumentPosition;if(f)return f;f=(g.ownerDocument||g)===(b.ownerDocument||b)?g.compareDocumentPosition(b):1;return f&1||!G.sortDetached&&b.compareDocumentPosition(g)===f?g===a||g.ownerDocument===Y&&ra(Y,g)?-1:b===a||b.ownerDocument===Y&&ra(Y,b)?1:qa?Ua.call(qa,g)-Ua.call(qa,b):0:f&4?-1:1}:function(g,b){if(g===b)return Aa=!0,0;var f,c=0;f=g.parentNode;var j=b.parentNode,d=[g],n=[b];if(!f||!j)return g===a?-1:b===a?1:f?-1:j?1:qa?Ua.call(qa,
g)-Ua.call(qa,b):0;if(f===j)return pc(g,b);for(f=g;f=f.parentNode;)d.unshift(f);for(f=b;f=f.parentNode;)n.unshift(f);for(;d[c]===n[c];)c++;return c?pc(d[c],n[c]):d[c]===Y?-1:n[c]===Y?1:0};return a};D.matches=function(g,a){return D(g,null,null,a)};D.matchesSelector=function(g,a){(g.ownerDocument||g)!==Q&&oa(g);a=a.replace(od,"='$1']");if(G.matchesSelector&&Z&&(!ea||!ea.test(a))&&(!R||!R.test(a)))try{var b=Ja.call(g,a);if(b||G.disconnectedMatch||g.document&&11!==g.document.nodeType)return b}catch(f){}return 0<
D(a,Q,null,[g]).length};D.contains=function(g,a){(g.ownerDocument||g)!==Q&&oa(g);return ra(g,a)};D.attr=function(g,a){(g.ownerDocument||g)!==Q&&oa(g);var b=F.attrHandle[a.toLowerCase()],b=b&&fa.call(F.attrHandle,a.toLowerCase())?b(g,a,!Z):void 0;return void 0!==b?b:G.attributes||!Z?g.getAttribute(a):(b=g.getAttributeNode(a))&&b.specified?b.value:null};D.error=function(g){throw Error("Syntax error, unrecognized expression: "+g);};D.uniqueSort=function(g){var a,b=[],f=0,c=0;Aa=!G.detectDuplicates;qa=
!G.sortStable&&g.slice(0);g.sort(A);if(Aa){for(;a=g[c++];)a===g[c]&&(f=b.push(c));for(;f--;)g.splice(b[f],1)}qa=null;return g};Ia=D.getText=function(g){var a,b="",f=0;if(a=g.nodeType)if(1===a||9===a||11===a){if("string"===typeof g.textContent)return g.textContent;for(g=g.firstChild;g;g=g.nextSibling)b+=Ia(g)}else{if(3===a||4===a)return g.nodeValue}else for(;a=g[f++];)b+=Ia(a);return b};F=D.selectors={cacheLength:50,createPseudo:S,match:xb,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0},
...
g.className||typeof g.getAttribute!==T&&g.getAttribute("class")||"")})},ATTR:function(g,a,b){return function(f){f=D.attr(f,g);if(null==f)return"!="===a;if(!a)return!0;f+="";return"="===a?f===b:"!="===a?f!==b:"^="===a?b&&0===f.indexOf(b):"*="===a?b&&-1<f.indexOf(b):"$="===a?b&&f.slice(-b.length)===b:"~="===a?-1<(" "+f+" ").indexOf(b):"|="===a?f===b||f.slice(0,b.length+1)===b+"-":!1}},CHILD:function(g,a,b,f,c){var j="nth"!==g.slice(0,3),d="last"!==g.slice(-4),n="of-type"===a;return 1===f&&0===c?function(g){return!!g.parentNode}:
function(a,b,p){var v,e,r,h,k;b=j!==d?"nextSibling":"previousSibling";var q=a.parentNode,l=n&&a.nodeName.toLowerCase();p=!p&&!n;if(q){if(j){for(;b;){for(e=a;e=e[b];)if(n?e.nodeName.toLowerCase()===l:1===e.nodeType)return!1;k=b="only"===g&&!k&&"nextSibling"}return!0}k=[d?q.firstChild:q.lastChild];if(d&&p){p=q[K]||(q[K]={});v=p[g]||[];h=v[0]===da&&v[1];r=v[0]===da&&v[2];for(e=h&&q.childNodes[h];e=++h&&e&&e[b]||(r=h=0)||k.pop();)if(1===e.nodeType&&++r&&e===a){p[g]=[da,h,r];break}}else if(p&&(v=(a[K]||
(a[K]={}))[g])&&v[0]===da)r=v[1];else for(;e=++h&&e&&e[b]||(r=h=0)||k.pop();)if((n?e.nodeName.toLowerCase()===l:1===e.nodeType)&&++r)if(p&&((e[K]||(e[K]={}))[g]=[da,r]),e===a)break;r-=c;return r===f||0===r%f&&0<=r/f}}},PSEUDO:function(g,a){var b,f=F.pseudos[g]||F.setFilters[g.toLowerCase()]||D.error("unsupported pseudo: "+g);return f[K]?f(a):1<f.length?(b=[g,g,"",a],F.setFilters.hasOwnProperty(g.toLowerCase())?S(function(g,b){for(var p,c=f(g,a),j=c.length;j--;)p=Ua.call(g,c[j]),g[p]=!(b[p]=c[j])}):
function(g){return f(g,0,b)}):f}},pseudos:{not:S(function(g){var a=[],b=[],f=$a(g.replace(wb,"$1"));return f[K]?S(function(g,a,b,p){p=f(g,null,p,[]);for(var v=g.length;v--;)if(b=p[v])g[v]=!(a[v]=b)}):function(g,c,j){a[0]=g;f(a,null,j,b);return!b.pop()}}),has:S(function(g){return function(a){return 0<D(g,a).length}}),contains:S(function(g){return function(a){return-1<(a.textContent||a.innerText||Ia(a)).indexOf(g)}}),lang:S(function(g){qd.test(g||"")||D.error("unsupported lang: "+g);g=g.replace(Fa,
Ga).toLowerCase();return function(a){var b;do if(b=Z?a.lang:a.getAttribute("xml:lang")||a.getAttribute("lang"))return b=b.toLowerCase(),b===g||0===b.indexOf(g+"-");while((a=a.parentNode)&&1===a.nodeType);return!1}}),target:function(g){var a=Pb.location&&Pb.location.hash;return a&&a.slice(1)===g.id},root:function(g){return g===ja},focus:function(g){return g===Q.activeElement&&(!Q.hasFocus||Q.hasFocus())&&!(!g.type&&!g.href&&!~g.tabIndex)},enabled:function(g){return!1===g.disabled},disabled:function(g){return!0===
...
a&&"button"===g.type||"button"===a},text:function(g){var a;return"input"===g.nodeName.toLowerCase()&&"text"===g.type&&(null==(a=g.getAttribute("type"))||"text"===a.toLowerCase())},first:Sa(function(){return[0]}),last:Sa(function(g,a){return[a-1]}),eq:Sa(function(g,a,b){return[0>b?b+a:b]}),even:Sa(function(g,a){for(var b=0;b<a;b+=2)g.push(b);return g}),odd:Sa(function(g,a){for(var b=1;b<a;b+=2)g.push(b);return g}),lt:Sa(function(g,a,b){for(a=0>b?b+a:b;0<=--a;)g.push(a);return g}),gt:Sa(function(g,
a,b){for(b=0>b?b+a:b;++b<a;)g.push(b);return g})}};F.pseudos.nth=F.pseudos.eq;for(za in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})F.pseudos[za]=id(za);for(za in{submit:!0,reset:!0})F.pseudos[za]=jd(za);qc.prototype=F.filters=F.pseudos;F.setFilters=new qc;$a=D.compile=function(g,a){var b,f=[],c=[],j=Ba[g+" "];if(!j){a||(a=sa(g));for(b=a.length;b--;)j=Wb(a[b]),j[K]?f.push(j):c.push(j);var d=0<f.length,n=0<c.length;b=function(g,a,b,p,v){var j,e,r,h=0,k="0",Na=g&&[],q=[],l=ya,A=g||n&&F.find.TAG("*",
v),z=da+=null==l?1:Math.random()||0.1,T=A.length;for(v&&(ya=a!==Q&&a);k!==T&&null!=(j=A[k]);k++){if(n&&j){for(e=0;r=c[e++];)if(r(j,a,b)){p.push(j);break}v&&(da=z)}d&&((j=!r&&j)&&h--,g&&Na.push(j))}h+=k;if(d&&k!==h){for(e=0;r=f[e++];)r(Na,q,a,b);if(g){if(0<h)for(;k--;)!Na[k]&&!q[k]&&(q[k]=aa.call(p));q=Ta(q)}Ea.apply(p,q);v&&(!g&&0<q.length&&1<h+f.length)&&D.uniqueSort(p)}v&&(da=z,ya=l);return Na};b=d?S(b):b;j=Ba(g,b)}return j};G.sortStable=K.split("").sort(A).join("")===K;G.detectDuplicates=!!Aa;
oa();G.sortDetached=pa(function(g){return g.compareDocumentPosition(Q.createElement("div"))&1});pa(function(g){g.innerHTML="<a href='#'></a>";return"#"===g.firstChild.getAttribute("href")})||Sb("type|href|height|width",function(g,a,b){if(!b)return g.getAttribute(a,"type"===a.toLowerCase()?1:2)});(!G.attributes||!pa(function(g){g.innerHTML="<input/>";g.firstChild.setAttribute("value","");return""===g.firstChild.getAttribute("value")}))&&Sb("value",function(g,a,b){if(!b&&"input"===g.nodeName.toLowerCase())return g.defaultValue});
pa(function(g){return null==g.getAttribute("disabled")})||Sb("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",function(g,a,b){var f;if(!b)return!0===g[a]?a.toLowerCase():(f=g.getAttributeNode(a))&&f.specified?f.value:null});f.find=D;f.expr=D.selectors;f.expr[":"]=f.expr.pseudos;f.unique=D.uniqueSort;f.text=D.getText;f.isXMLDoc=D.isXML;f.contains=D.contains;var wc=f.expr.match.needsContext,xc=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Vc=
/^.[^:#\[\.,]*$/;f.filter=function(g,a,b){var c=a[0];b&&(g=":not("+g+")");return 1===a.length&&1===c.nodeType?f.find.matchesSelector(c,g)?[c]:[]:f.find.matches(g,f.grep(a,function(g){return 1===g.nodeType}))};f.fn.extend({find:function(g){var a,b=[],c=this,j=c.length;if("string"!==typeof g)return this.pushStack(f(g).filter(function(){for(a=0;a<j;a++)if(f.contains(c[a],this))return!0}));for(a=0;a<j;a++)f.find(g,c[a],b);b=this.pushStack(1<j?f.unique(b):b);b.selector=this.selector?this.selector+" "+
...
c){var j=f.map(this,a,b);"Until"!==g.slice(-5)&&(c=b);c&&"string"===typeof c&&(j=f.filter(c,j));1<this.length&&(vd[g]||(j=f.unique(j)),ud.test(g)&&(j=j.reverse()));return this.pushStack(j)}});var va=/\S+/g,yc={};f.Callbacks=function(g){var a;if("string"===typeof g){if(!(a=yc[g])){a=g;var b=yc[a]={};f.each(a.match(va)||[],function(g,a){b[a]=!0});a=b}}else a=f.extend({},g);g=a;var c,j,d,n,e,r,h=[],k=!g.once&&[],q=function(a){j=g.memory&&a;d=!0;e=r||0;r=0;n=h.length;for(c=!0;h&&e<n;e++)if(!1===h[e].apply(a[0],
a[1])&&g.stopOnFalse){j=!1;break}c=!1;h&&(k?k.length&&q(k.shift()):j?h=[]:l.disable())},l={add:function(){if(h){var a=h.length;(function $c(a){f.each(a,function(a,b){var p=f.type(b);"function"===p?(!g.unique||!l.has(b))&&h.push(b):b&&(b.length&&"string"!==p)&&$c(b)})})(arguments);c?n=h.length:j&&(r=a,q(j))}return this},remove:function(){h&&f.each(arguments,function(g,a){for(var b;-1<(b=f.inArray(a,h,b));)h.splice(b,1),c&&(b<=n&&n--,b<=e&&e--)});return this},has:function(g){return g?-1<f.inArray(g,
h):!(!h||!h.length)},empty:function(){h=[];n=0;return this},disable:function(){h=k=j=void 0;return this},disabled:function(){return!h},lock:function(){k=void 0;j||l.disable();return this},locked:function(){return!k},fireWith:function(g,a){if(h&&(!d||k))a=a||[],a=[g,a.slice?a.slice():a],c?k.push(a):q(a);return this},fire:function(){l.fireWith(this,arguments);return this},fired:function(){return!!d}};return l};f.extend({Deferred:function(g){var a=[["resolve","done",f.Callbacks("once memory"),"resolved"],
["reject","fail",f.Callbacks("once memory"),"rejected"],["notify","progress",f.Callbacks("memory")]],b="pending",c={state:function(){return b},always:function(){j.done(arguments).fail(arguments);return this},then:function(){var g=arguments;return f.Deferred(function(b){f.each(a,function(a,p){var v=f.isFunction(g[a])&&g[a];j[p[1]](function(){var g=v&&v.apply(this,arguments);if(g&&f.isFunction(g.promise))g.promise().done(b.resolve).fail(b.reject).progress(b.notify);else b[p[0]+"With"](this===c?b.promise():
this,v?[g]:arguments)})});g=null}).promise()},promise:function(g){return null!=g?f.extend(g,c):c}},j={};c.pipe=c.then;f.each(a,function(g,f){var d=f[2],n=f[3];c[f[1]]=d.add;n&&d.add(function(){b=n},a[g^1][2].disable,a[2][2].lock);j[f[0]]=function(){j[f[0]+"With"](this===j?c:this,arguments);return this};j[f[0]+"With"]=d.fireWith});c.promise(j);g&&g.call(j,j);return j},when:function(g){var a=0,b=n.call(arguments),c=b.length,j=1!==c||g&&f.isFunction(g.promise)?c:0,d=1===j?g:f.Deferred(),e=function(g,
a,b){return function(f){a[g]=this;b[g]=1<arguments.length?n.call(arguments):f;b===r?d.notifyWith(a,b):--j||d.resolveWith(a,b)}},r,h,k;if(1<c){r=Array(c);h=Array(c);for(k=Array(c);a<c;a++)b[a]&&f.isFunction(b[a].promise)?b[a].promise().done(e(a,k,b)).fail(d.reject).progress(e(a,h,r)):--j}j||d.resolveWith(k,b);return d.promise()}});var yb;f.fn.ready=function(g){f.ready.promise().done(g);return this};f.extend({isReady:!1,readyWait:1,holdReady:function(g){g?f.readyWait++:f.ready(!0)},ready:function(g){if(!(!0===
g?--f.readyWait:f.isReady)){if(!y.body)return setTimeout(f.ready);f.isReady=!0;!0!==g&&0<--f.readyWait||(yb.resolveWith(y,[f]),f.fn.trigger&&f(y).trigger("ready").off("ready"))}}});f.ready.promise=function(g){if(!yb)if(yb=f.Deferred(),"complete"===y.readyState)setTimeout(f.ready);else if(y.addEventListener)y.addEventListener("DOMContentLoaded",s,!1),a.addEventListener("load",s,!1);else{y.attachEvent("onreadystatechange",s);a.attachEvent("onload",s);var b=!1;try{b=null==a.frameElement&&y.documentElement}catch(c){}b&&
b.doScroll&&function Uc(){if(!f.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Uc,50)}k();f.ready()}}()}return yb.promise(g)};var la="undefined",zc;for(zc in f(w))break;w.ownLast="0"!==zc;w.inlineBlockNeedsLayout=!1;f(function(){var g,a,b=y.getElementsByTagName("body")[0];if(b){g=y.createElement("div");g.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px";a=y.createElement("div");b.appendChild(g).appendChild(a);if(typeof a.style.zoom!==la&&(a.style.cssText=
...
"embed ":!0,"object ":"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(g){g=g.nodeType?f.cache[g[f.expando]]:g[f.expando];return!!g&&!u(g)},data:function(g,a,f){return b(g,a,f)},removeData:function(g,a){return c(g,a)},_data:function(g,a,f){return b(g,a,f,!0)},_removeData:function(g,a){return c(g,a,!0)}});f.fn.extend({data:function(g,a){var b,c,j,d=this[0],n=d&&d.attributes;if(void 0===g){if(this.length&&(j=f.data(d),1===d.nodeType&&!f._data(d,"parsedAttrs"))){for(b=n.length;b--;)c=n[b].name,
0===c.indexOf("data-")&&(c=f.camelCase(c.slice(5)),t(d,c,j[c]));f._data(d,"parsedAttrs",!0)}return j}return"object"===typeof g?this.each(function(){f.data(this,g)}):1<arguments.length?this.each(function(){f.data(this,g,a)}):d?t(d,g,f.data(d,g)):void 0},removeData:function(g){return this.each(function(){f.removeData(this,g)})}});f.extend({queue:function(g,a,b){var c;if(g)return a=(a||"fx")+"queue",c=f._data(g,a),b&&(!c||f.isArray(b)?c=f._data(g,a,f.makeArray(b)):c.push(b)),c||[]},dequeue:function(g,
a){a=a||"fx";var b=f.queue(g,a),c=b.length,j=b.shift(),d=f._queueHooks(g,a),n=function(){f.dequeue(g,a)};"inprogress"===j&&(j=b.shift(),c--);j&&("fx"===a&&b.unshift("inprogress"),delete d.stop,j.call(g,n,d));!c&&d&&d.empty.fire()},_queueHooks:function(g,a){var b=a+"queueHooks";return f._data(g,b)||f._data(g,b,{empty:f.Callbacks("once memory").add(function(){f._removeData(g,a+"queue");f._removeData(g,b)})})}});f.fn.extend({queue:function(a,b){var c=2;"string"!==typeof a&&(b=a,a="fx",c--);return arguments.length<
c?f.queue(this[0],a):void 0===b?this:this.each(function(){var c=f.queue(this,a,b);f._queueHooks(this,a);"fx"===a&&"inprogress"!==c[0]&&f.dequeue(this,a)})},dequeue:function(a){return this.each(function(){f.dequeue(this,a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var c,j=1,d=f.Deferred(),n=this,e=this.length,r=function(){--j||d.resolveWith(n,[n])};"string"!==typeof a&&(b=a,a=void 0);for(a=a||"fx";e--;)if((c=f._data(n[e],a+"queueHooks"))&&c.empty)j++,c.empty.add(r);
r();return d.promise(b)}});var zb=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Pa=["Top","Right","Bottom","Left"],hb=function(a,b){a=b||a;return"none"===f.css(a,"display")||!f.contains(a.ownerDocument,a)},Va=f.access=function(a,b,c,j,d,n,e){var r=0,h=a.length,k=null==c;if("object"===f.type(c))for(r in d=!0,c)f.access(a,b,r,c[r],!0,n,e);else if(void 0!==j&&(d=!0,f.isFunction(j)||(e=!0),k&&(e?(b.call(a,j),b=null):(k=b,b=function(a,g,b){return k.call(f(a),b)})),b))for(;r<h;r++)b(a[r],c,e?j:j.call(a[r],
r,b(a[r],c)));return d?a:k?b.call(a):h?b(a[0],c):n},Mb=/^(?:checkbox|radio)$/i,Yb=y.createDocumentFragment(),ba=y.createElement("div"),nb=y.createElement("input");ba.setAttribute("className","t");ba.innerHTML="  <link/><table></table><a href='/a'>a</a>";w.leadingWhitespace=3===ba.firstChild.nodeType;w.tbody=!ba.getElementsByTagName("tbody").length;w.htmlSerialize=!!ba.getElementsByTagName("link").length;w.html5Clone="<:nav></:nav>"!==y.createElement("nav").cloneNode(!0).outerHTML;nb.type="checkbox";
nb.checked=!0;Yb.appendChild(nb);w.appendChecked=nb.checked;ba.innerHTML="<textarea>x</textarea>";w.noCloneChecked=!!ba.cloneNode(!0).lastChild.defaultValue;Yb.appendChild(ba);ba.innerHTML="<input type='radio' checked='checked' name='t'/>";w.checkClone=ba.cloneNode(!0).cloneNode(!0).lastChild.checked;w.noCloneEvent=!0;ba.attachEvent&&(ba.attachEvent("onclick",function(){w.noCloneEvent=!1}),ba.cloneNode(!0).click());if(null==w.deleteExpando){w.deleteExpando=!0;try{delete ba.test}catch(ae){w.deleteExpando=
!1}}var Yb=ba=nb=null,Ab,Bb,Ac=y.createElement("div");for(Ab in{submit:!0,change:!0,focusin:!0})if(Bb="on"+Ab,!(w[Ab+"Bubbles"]=Bb in a))Ac.setAttribute(Bb,"t"),w[Ab+"Bubbles"]=!1===Ac.attributes[Bb].expando;var Zb=/^(?:input|select|textarea)$/i,xd=/^key/,yd=/^(?:mouse|contextmenu)|click/,Bc=/^(?:focusinfocus|focusoutblur)$/,Cc=/^([^.]*)(?:\.(.+)|)$/;f.event={global:{},add:function(a,b,c,j,d){var n,e,r,h,k,q,l,A,z;if(r=f._data(a)){c.handler&&(h=c,c=h.handler,d=h.selector);c.guid||(c.guid=f.guid++);
if(!(e=r.events))e=r.events={};if(!(k=r.handle))k=r.handle=function(a){return typeof f!==la&&(!a||f.event.triggered!==a.type)?f.event.dispatch.apply(k.elem,arguments):void 0},k.elem=a;b=(b||"").match(va)||[""];for(r=b.length;r--;)if(n=Cc.exec(b[r])||[],A=q=n[1],z=(n[2]||"").split(".").sort(),A){n=f.event.special[A]||{};A=(d?n.delegateType:n.bindType)||A;n=f.event.special[A]||{};q=f.extend({type:A,origType:q,data:j,handler:c,guid:c.guid,selector:d,needsContext:d&&f.expr.match.needsContext.test(d),
namespace:z.join(".")},h);if(!(l=e[A]))if(l=e[A]=[],l.delegateCount=0,!n.setup||!1===n.setup.call(a,j,z,k))a.addEventListener?a.addEventListener(A,k,!1):a.attachEvent&&a.attachEvent("on"+A,k);n.add&&(n.add.call(a,q),q.handler.guid||(q.handler.guid=c.guid));d?l.splice(l.delegateCount++,0,q):l.push(q);f.event.global[A]=!0}a=null}},remove:function(a,b,c,j,d){var n,e,r,h,k,q,l,A,z,T,s,L=f.hasData(a)&&f._data(a);if(L&&(q=L.events)){b=(b||"").match(va)||[""];for(k=b.length;k--;)if(r=Cc.exec(b[k])||[],z=
s=r[1],T=(r[2]||"").split(".").sort(),z){l=f.event.special[z]||{};z=(j?l.delegateType:l.bindType)||z;A=q[z]||[];r=r[2]&&RegExp("(^|\\.)"+T.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=n=A.length;n--;)if(e=A[n],(d||s===e.origType)&&(!c||c.guid===e.guid)&&(!r||r.test(e.namespace))&&(!j||j===e.selector||"**"===j&&e.selector))A.splice(n,1),e.selector&&A.delegateCount--,l.remove&&l.remove.call(a,e);h&&!A.length&&((!l.teardown||!1===l.teardown.call(a,T,L.handle))&&f.removeEvent(a,z,L.handle),delete q[z])}else for(z in q)f.event.remove(a,
z+b[k],c,j,!0);f.isEmptyObject(q)&&(delete L.handle,f._removeData(a,"events"))}},trigger:function(g,b,c,j){var d,n,e,r,h,k,q=[c||y],l=xa.call(g,"type")?g.type:g;h=xa.call(g,"namespace")?g.namespace.split("."):[];e=d=c=c||y;if(!(3===c.nodeType||8===c.nodeType)&&!Bc.test(l+f.event.triggered))if(0<=l.indexOf(".")&&(h=l.split("."),l=h.shift(),h.sort()),n=0>l.indexOf(":")&&"on"+l,g=g[f.expando]?g:new f.Event(l,"object"===typeof g&&g),g.isTrigger=j?2:3,g.namespace=h.join("."),g.namespace_re=g.namespace?
RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=void 0,g.target||(g.target=c),b=null==b?[g]:f.makeArray(b,[g]),h=f.event.special[l]||{},j||!(h.trigger&&!1===h.trigger.apply(c,b))){if(!j&&!h.noBubble&&!f.isWindow(c)){r=h.delegateType||l;Bc.test(r+l)||(e=e.parentNode);for(;e;e=e.parentNode)q.push(e),d=e;if(d===(c.ownerDocument||y))q.push(d.defaultView||d.parentWindow||a)}for(k=0;(e=q[k++])&&!g.isPropagationStopped();)if(g.type=1<k?r:h.bindType||l,(d=(f._data(e,"events")||{})[g.type]&&
f._data(e,"handle"))&&d.apply(e,b),(d=n&&e[n])&&d.apply&&f.acceptData(e))g.result=d.apply(e,b),!1===g.result&&g.preventDefault();g.type=l;if(!j&&!g.isDefaultPrevented()&&(!h._default||!1===h._default.apply(q.pop(),b))&&f.acceptData(c)&&n&&c[l]&&!f.isWindow(c)){(d=c[n])&&(c[n]=null);f.event.triggered=l;try{c[l]()}catch(A){}f.event.triggered=void 0;d&&(c[n]=d)}return g.result}},dispatch:function(a){a=f.event.fix(a);var b,c,j,d,e=[],r=n.call(arguments);b=(f._data(this,"events")||{})[a.type]||[];var h=
f.event.special[a.type]||{};r[0]=a;a.delegateTarget=this;if(!(h.preDispatch&&!1===h.preDispatch.call(this,a))){e=f.event.handlers.call(this,a,b);for(b=0;(j=e[b++])&&!a.isPropagationStopped();){a.currentTarget=j.elem;for(d=0;(c=j.handlers[d++])&&!a.isImmediatePropagationStopped();)if(!a.namespace_re||a.namespace_re.test(c.namespace))if(a.handleObj=c,a.data=c.data,c=((f.event.special[c.origType]||{}).handle||c.handler).apply(j.elem,r),void 0!==c&&!1===(a.result=c))a.preventDefault(),a.stopPropagation()}h.postDispatch&&
h.postDispatch.call(this,a);return a.result}},handlers:function(a,b){var c,j,d,n,e=[],r=b.delegateCount,h=a.target;if(r&&h.nodeType&&(!a.button||"click"!==a.type))for(;h!=this;h=h.parentNode||this)if(1===h.nodeType&&(!0!==h.disabled||"click"!==a.type)){d=[];for(n=0;n<r;n++)j=b[n],c=j.selector+" ",void 0===d[c]&&(d[c]=j.needsContext?0<=f(c,this).index(h):f.find(c,this,null,[h]).length),d[c]&&d.push(j);d.length&&e.push({elem:h,handlers:d})}r<b.length&&e.push({elem:this,handlers:b.slice(r)});return e},
fix:function(a){if(a[f.expando])return a;var b,c,j;b=a.type;var d=a,n=this.fixHooks[b];n||(this.fixHooks[b]=n=yd.test(b)?this.mouseHooks:xd.test(b)?this.keyHooks:{});j=n.props?this.props.concat(n.props):this.props;a=new f.Event(d);for(b=j.length;b--;)c=j[b],a[c]=d[c];a.target||(a.target=d.srcElement||y);3===a.target.nodeType&&(a.target=a.target.parentNode);a.metaKey=!!a.metaKey;return n.filter?n.filter(a,d):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),
fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode);return a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,b){var f,c,j=b.button,d=b.fromElement;null==a.pageX&&null!=b.clientX&&(f=a.target.ownerDocument||y,c=f.documentElement,f=f.body,a.pageX=b.clientX+(c&&c.scrollLeft||f&&f.scrollLeft||0)-(c&&c.clientLeft||
f&&f.clientLeft||0),a.pageY=b.clientY+(c&&c.scrollTop||f&&f.scrollTop||0)-(c&&c.clientTop||f&&f.clientTop||0));!a.relatedTarget&&d&&(a.relatedTarget=d===a.target?b.toElement:d);!a.which&&void 0!==j&&(a.which=j&1?1:j&2?3:j&4?2:0);return a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==L()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){if(this===L()&&this.blur)return this.blur(),!1},delegateType:"focusout"},click:{trigger:function(){if(f.nodeName(this,
"input")&&"checkbox"===this.type&&this.click)return this.click(),!1},_default:function(a){return f.nodeName(a.target,"a")}},beforeunload:{postDispatch:function(a){void 0!==a.result&&(a.originalEvent.returnValue=a.result)}}},simulate:function(a,b,c,j){a=f.extend(new f.Event,c,{type:a,isSimulated:!0,originalEvent:{}});j?f.event.trigger(a,null,b):f.event.dispatch.call(b,a);a.isDefaultPrevented()&&c.preventDefault()}};f.removeEvent=y.removeEventListener?function(a,b,f){a.removeEventListener&&a.removeEventListener(b,
...
bindType:b,handle:function(a){var g,c=a.relatedTarget,j=a.handleObj;if(!c||c!==this&&!f.contains(this,c))a.type=j.origType,g=j.handler.apply(this,arguments),a.type=b;return g}}});w.submitBubbles||(f.event.special.submit={setup:function(){if(f.nodeName(this,"form"))return!1;f.event.add(this,"click._submit keypress._submit",function(a){a=a.target;if((a=f.nodeName(a,"input")||f.nodeName(a,"button")?a.form:void 0)&&!f._data(a,"submitBubbles"))f.event.add(a,"submit._submit",function(a){a._submit_bubble=
...
if(this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type)return a.handleObj.handler.apply(this,arguments)},teardown:function(){f.event.remove(this,"._change");return!Zb.test(this.nodeName)}});w.focusinBubbles||f.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){f.event.simulate(b,a.target,f.event.fix(a),!0)};f.event.special[b]={setup:function(){var j=this.ownerDocument||this,d=f._data(j,b);d||j.addEventListener(a,c,!0);f._data(j,b,(d||0)+1)},teardown:function(){var j=
this.ownerDocument||this,d=f._data(j,b)-1;d?f._data(j,b,d):(j.removeEventListener(a,c,!0),f._removeData(j,b))}}});f.fn.extend({on:function(a,b,c,j,d){var n,e;if("object"===typeof a){"string"!==typeof b&&(c=c||b,b=void 0);for(n in a)this.on(n,b,c,a[n],d);return this}null==c&&null==j?(j=b,c=b=void 0):null==j&&("string"===typeof b?(j=c,c=void 0):(j=c,c=b,b=void 0));if(!1===j)j=q;else if(!j)return this;1===d&&(e=j,j=function(a){f().off(a);return e.apply(this,arguments)},j.guid=e.guid||(e.guid=f.guid++));
return this.each(function(){f.event.add(this,a,j,c,b)})},one:function(a,b,f,c){return this.on(a,b,f,c,1)},off:function(a,b,c){var j;if(a&&a.preventDefault&&a.handleObj)return j=a.handleObj,f(a.delegateTarget).off(j.namespace?j.origType+"."+j.namespace:j.origType,j.selector,j.handler),this;if("object"===typeof a){for(j in a)this.off(j,b,a[j]);return this}if(!1===b||"function"===typeof b)c=b,b=void 0;!1===c&&(c=q);return this.each(function(){f.event.remove(this,a,c,b)})},trigger:function(a,b){return this.each(function(){f.event.trigger(a,
...
U(y).appendChild(y.createElement("div"));ka.optgroup=ka.option;ka.tbody=ka.tfoot=ka.colgroup=ka.caption=ka.thead;ka.th=ka.td;f.extend({clone:function(a,b,c){var j,d,n,e,r,h=f.contains(a.ownerDocument,a);w.html5Clone||f.isXMLDoc(a)||!Dc.test("<"+a.nodeName+">")?n=a.cloneNode(!0):(ac.innerHTML=a.outerHTML,ac.removeChild(n=ac.firstChild));if((!w.noCloneEvent||!w.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!f.isXMLDoc(a)){j=C(n);r=C(a);for(e=0;null!=(d=r[e]);++e)if(j[e]){var k=j[e],l=void 0,q=
void 0,A=void 0;if(1===k.nodeType){l=k.nodeName.toLowerCase();if(!w.noCloneEvent&&k[f.expando]){A=f._data(k);for(q in A.events)f.removeEvent(k,q,A.handle);k.removeAttribute(f.expando)}if("script"===l&&k.text!==d.text)Ca(k).text=d.text,V(k);else if("object"===l)k.parentNode&&(k.outerHTML=d.outerHTML),w.html5Clone&&(d.innerHTML&&!f.trim(k.innerHTML))&&(k.innerHTML=d.innerHTML);else if("input"===l&&Mb.test(d.type))k.defaultChecked=k.checked=d.checked,k.value!==d.value&&(k.value=d.value);else if("option"===
l)k.defaultSelected=k.selected=d.defaultSelected;else if("input"===l||"textarea"===l)k.defaultValue=d.defaultValue}}}if(b)if(c){r=r||C(a);j=j||C(n);for(e=0;null!=(d=r[e]);e++)Da(d,j[e])}else Da(a,n);j=C(n,"script");0<j.length&&P(j,!h&&C(a,"script"));return n},buildFragment:function(a,b,c,j){for(var d,n,e,r,h,k,l=a.length,q=U(b),A=[],z=0;z<l;z++)if((n=a[z])||0===n)if("object"===f.type(n))f.merge(A,n.nodeType?[n]:n);else if(Ad.test(n)){e=e||q.appendChild(b.createElement("div"));r=(Fc.exec(n)||["",""])[1].toLowerCase();
k=ka[r]||ka._default;e.innerHTML=k[1]+n.replace(Ec,"<$1></$2>")+k[2];for(d=k[0];d--;)e=e.lastChild;!w.leadingWhitespace&&$b.test(n)&&A.push(b.createTextNode($b.exec(n)[0]));if(!w.tbody)for(d=(n="table"===r&&!Gc.test(n)?e.firstChild:"<table>"===k[1]&&!Gc.test(n)?e:0)&&n.childNodes.length;d--;)f.nodeName(h=n.childNodes[d],"tbody")&&!h.childNodes.length&&n.removeChild(h);f.merge(A,e.childNodes);for(e.textContent="";e.firstChild;)e.removeChild(e.firstChild);e=q.lastChild}else A.push(b.createTextNode(n));
e&&q.removeChild(e);w.appendChecked||f.grep(C(A,"input"),rb);for(z=0;n=A[z++];)if(!(j&&-1!==f.inArray(n,j))&&(a=f.contains(n.ownerDocument,n),e=C(q.appendChild(n),"script"),a&&P(e),c))for(d=0;n=e[d++];)Hc.test(n.type||"")&&c.push(n);return q},cleanData:function(a,b){for(var c,d,n,e,r=0,h=f.expando,k=f.cache,l=w.deleteExpando,q=f.event.special;null!=(c=a[r]);r++)if(b||f.acceptData(c))if(e=(n=c[h])&&k[n]){if(e.events)for(d in e.events)q[d]?f.event.remove(c,d):f.removeEvent(c,d,e.handle);k[n]&&(delete k[n],
l?delete c[h]:typeof c.removeAttribute!==la?c.removeAttribute(h):c[h]=null,j.push(n))}}});f.fn.extend({text:function(a){return Va(this,function(a){return void 0===a?f.text(this):this.empty().append((this[0]&&this[0].ownerDocument||y).createTextNode(a))},null,a,arguments.length)},append:function(){return this.domManip(arguments,function(a){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&Ya(this,a).appendChild(a)})},prepend:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||
11===this.nodeType||9===this.nodeType){var b=Ya(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,j=a?f.filter(a,this):this,d=0;null!=(c=j[d]);d++)!b&&1===c.nodeType&&f.cleanData(C(c)),c.parentNode&&(b&&f.contains(c.ownerDocument,
c)&&P(C(c,"script")),c.parentNode.removeChild(c));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&f.cleanData(C(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&f.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return f.clone(this,a,b)})},html:function(a){return Va(this,function(a){var g=this[0]||{},b=0,c=this.length;if(void 0===a)return 1===g.nodeType?g.innerHTML.replace(zd,
""):void 0;if("string"===typeof a&&!Bd.test(a)&&(w.htmlSerialize||!Dc.test(a))&&(w.leadingWhitespace||!$b.test(a))&&!ka[(Fc.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Ec,"<$1></$2>");try{for(;b<c;b++)g=this[b]||{},1===g.nodeType&&(f.cleanData(C(g,!1)),g.innerHTML=a);g=0}catch(j){}}g&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];this.domManip(arguments,function(b){a=this.parentNode;f.cleanData(C(this));a&&a.replaceChild(b,this)});return a&&(a.length||
a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=r.apply([],a);var c,j,d,n,e=0,h=this.length,k=this,l=h-1,q=a[0],A=f.isFunction(q);if(A||1<h&&"string"===typeof q&&!w.checkClone&&Cd.test(q))return this.each(function(c){var f=k.eq(c);A&&(a[0]=q.call(this,c,f.html()));f.domManip(a,b)});if(h&&(n=f.buildFragment(a,this[0].ownerDocument,!1,this),c=n.firstChild,1===n.childNodes.length&&(n=c),c)){d=f.map(C(n,"script"),Ca);for(j=d.length;e<h;e++)c=n,e!==
l&&(c=f.clone(c,!0,!0),j&&f.merge(d,C(c,"script"))),b.call(this[e],c,e);if(j){n=d[d.length-1].ownerDocument;f.map(d,V);for(e=0;e<j;e++)if(c=d[e],Hc.test(c.type||"")&&!f._data(c,"globalEval")&&f.contains(n,c))c.src?f._evalUrl&&f._evalUrl(c.src):f.globalEval((c.text||c.textContent||c.innerHTML||"").replace(Dd,""))}n=c=null}return this}});f.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){f.fn[a]=function(a){for(var g=0,c=[],
j=f(a),d=j.length-1;g<=d;g++)a=g===d?this:this.clone(!0),f(j[g])[b](a),z.apply(c,a.get());return this.pushStack(c)}});var eb,nc={},ob,Cb,ab=y.createElement("div");ab.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";ob=ab.getElementsByTagName("a")[0];ob.style.cssText="float:left;opacity:.5";w.opacity=/^0.5/.test(ob.style.opacity);w.cssFloat=!!ob.style.cssFloat;ab.style.backgroundClip="content-box";ab.cloneNode(!0).style.backgroundClip="";w.clearCloneStyle="content-box"===
...
a.removeChild(b)}return Cb};var Ic=/^margin/,sb=RegExp("^("+zb+")(?!px)[a-z%]+$","i"),Qa,Ra,Ed=/^(top|right|bottom|left)$/;a.getComputedStyle?(Qa=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)},Ra=function(a,b,c){var j,d,n=a.style;d=(c=c||Qa(a))?c.getPropertyValue(b)||c[b]:void 0;c&&(""===d&&!f.contains(a.ownerDocument,a)&&(d=f.style(a,b)),sb.test(d)&&Ic.test(b)&&(a=n.width,b=n.minWidth,j=n.maxWidth,n.minWidth=n.maxWidth=n.width=d,d=c.width,n.width=a,n.minWidth=b,n.maxWidth=
j));return void 0===d?d:d+""}):y.documentElement.currentStyle&&(Qa=function(a){return a.currentStyle},Ra=function(a,b,c){var f,j,d,n=a.style;d=(c=c||Qa(a))?c[b]:void 0;null==d&&(n&&n[b])&&(d=n[b]);if(sb.test(d)&&!Ed.test(b)){c=n.left;if(j=(f=a.runtimeStyle)&&f.left)f.left=a.currentStyle.left;n.left="fontSize"===b?"1em":d;d=n.pixelLeft+"px";n.left=c;j&&(f.left=j)}return void 0===d?d:d+""||"auto"});var dc=function(){var g,b,c=y.getElementsByTagName("body")[0];c&&(g=y.createElement("div"),b=y.createElement("div"),
...
"-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";f.style.marginRight=f.style.width="0";c.style.width="1px";Fb=!parseFloat((a.getComputedStyle(f,null)||{}).marginRight);g.removeChild(b)}return Fb}});f.swap=function(a,b,c,f){var j,d={};for(j in b)d[j]=a.style[j],a.style[j]=b[j];c=c.apply(a,f||[]);for(j in b)a.style[j]=d[j];return c};var ec=/alpha\([^)]*\)/i,Fd=/opacity\s*=\s*([^)]*)/,Gd=/^(none|table(?!-c[ea]).+)/,Zc=RegExp("^("+
zb+")(.*)$","i"),Hd=RegExp("^([+-])=("+zb+")","i"),Id={position:"absolute",visibility:"hidden",display:"block"},Jc={letterSpacing:0,fontWeight:400},oc=["Webkit","O","Moz","ms"];f.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Ra(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":w.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,c,j){if(a&&!(3===a.nodeType||
8===a.nodeType||!a.style)){var d,n,e,r=f.camelCase(b),h=a.style;b=f.cssProps[r]||(f.cssProps[r]=gb(h,r));e=f.cssHooks[b]||f.cssHooks[r];if(void 0!==c){n=typeof c;if("string"===n&&(d=Hd.exec(c)))c=(d[1]+1)*d[2]+parseFloat(f.css(a,b)),n="number";if(!(null==c||c!==c))if("number"===n&&!f.cssNumber[r]&&(c+="px"),!w.clearCloneStyle&&(""===c&&0===b.indexOf("background"))&&(h[b]="inherit"),!e||!("set"in e)||void 0!==(c=e.set(a,c,j)))try{h[b]="",h[b]=c}catch(k){}}else return e&&"get"in e&&void 0!==(d=e.get(a,
!1,j))?d:h[b]}},css:function(a,b,c,j){var d,n;n=f.camelCase(b);b=f.cssProps[n]||(f.cssProps[n]=gb(a.style,n));(n=f.cssHooks[b]||f.cssHooks[n])&&"get"in n&&(d=n.get(a,!0,c));void 0===d&&(d=Ra(a,b,j));"normal"===d&&b in Jc&&(d=Jc[b]);return""===c||c?(a=parseFloat(d),!0===c||f.isNumeric(a)?a||0:d):d}});f.each(["height","width"],function(a,b){f.cssHooks[b]={get:function(a,g,c){if(g)return 0===a.offsetWidth&&Gd.test(f.css(a,"display"))?f.swap(a,Id,function(){return W(a,b,c)}):W(a,b,c)},set:function(a,
g,c){var j=c&&Qa(a);return ma(a,g,c?x(a,b,c,w.boxSizing()&&"border-box"===f.css(a,"boxSizing",!1,j),j):0)}}});w.opacity||(f.cssHooks.opacity={get:function(a,b){return Fd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,j=a.currentStyle,d=f.isNumeric(b)?"alpha(opacity="+100*b+")":"",n=j&&j.filter||c.filter||"";c.zoom=1;if((1<=b||""===b)&&""===f.trim(n.replace(ec,""))&&c.removeAttribute)if(c.removeAttribute("filter"),
""===b||j&&!j.filter)return;c.filter=ec.test(n)?n.replace(ec,d):n+" "+d}});f.cssHooks.marginRight=fb(w.reliableMarginRight,function(a,b){if(b)return f.swap(a,{display:"inline-block"},Ra,[a,"marginRight"])});f.each({margin:"",padding:"",border:"Width"},function(a,b){f.cssHooks[a+b]={expand:function(c){var f=0,j={};for(c="string"===typeof c?c.split(" "):[c];4>f;f++)j[a+Pa[f]+b]=c[f]||c[f-2]||c[0];return j}};Ic.test(a)||(f.cssHooks[a+b].set=ma)});f.fn.extend({css:function(a,b){return Va(this,function(a,
g,b){var c,j={},d=0;if(f.isArray(g)){b=Qa(a);for(c=g.length;d<c;d++)j[g[d]]=f.css(a,g[d],!1,b);return j}return void 0!==b?f.style(a,g,b):f.css(a,g)},a,b,1<arguments.length)},show:function(){return ta(this,!0)},hide:function(){return ta(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){hb(this)?f(this).show():f(this).hide()})}});f.Tween=H;H.prototype={constructor:H,init:function(a,b,c,j,d,n){this.elem=a;this.prop=c;this.easing=d||"swing";this.options=
b;this.start=this.now=this.cur();this.end=j;this.unit=n||(f.cssNumber[c]?"":"px")},cur:function(){var a=H.propHooks[this.prop];return a&&a.get?a.get(this):H.propHooks._default.get(this)},run:function(a){var b,c=H.propHooks[this.prop];this.pos=this.options.duration?b=f.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&this.options.step.call(this.elem,this.now,this);c&&c.set?c.set(this):H.propHooks._default.set(this);
...
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};f.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};f.fx=H.prototype.init;f.fx.step={};var Za,Hb,Jd=/^(?:toggle|show|hide)$/,Kc=RegExp("^(?:([+-])=|)("+zb+")([a-z%]*)$","i"),Kd=/queueHooks$/,tb=[function(a,b,c){var j,d,n,e,r,h,k=this,q={},l=a.style,A=a.nodeType&&hb(a),z=f._data(a,"fxshow");c.queue||(e=f._queueHooks(a,"fx"),null==e.unqueued&&(e.unqueued=0,r=e.empty.fire,e.empty.fire=function(){e.unqueued||r()}),e.unqueued++,
k.always(function(){k.always(function(){e.unqueued--;f.queue(a,"fx").length||e.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))c.overflow=[l.overflow,l.overflowX,l.overflowY],d=f.css(a,"display"),h=db(a.nodeName),"none"===d&&(d=h),"inline"===d&&"none"===f.css(a,"float")&&(!w.inlineBlockNeedsLayout||"inline"===h?l.display="inline-block":l.zoom=1);c.overflow&&(l.overflow="hidden",w.shrinkWrapBlocks()||k.always(function(){l.overflow=c.overflow[0];l.overflowX=c.overflow[1];l.overflowY=
c.overflow[2]}));for(j in b)if(d=b[j],Jd.exec(d)){delete b[j];n=n||"toggle"===d;if(d===(A?"hide":"show"))if("show"===d&&z&&void 0!==z[j])A=!0;else continue;q[j]=z&&z[j]||f.style(a,j)}if(!f.isEmptyObject(q))for(j in z?"hidden"in z&&(A=z.hidden):z=f._data(a,"fxshow",{}),n&&(z.hidden=!A),A?f(a).show():k.done(function(){f(a).hide()}),k.done(function(){var b;f._removeData(a,"fxshow");for(b in q)f.style(a,b,q[b])}),q)b=ua(A?z[j]:0,j,k),j in z||(z[j]=b.start,A&&(b.end=b.start,b.start="width"===j||"height"===
j?1:0))}],ib={"*":[function(a,b){var c=this.createTween(a,b),j=c.cur(),d=Kc.exec(b),n=d&&d[3]||(f.cssNumber[a]?"":"px"),e=(f.cssNumber[a]||"px"!==n&&+j)&&Kc.exec(f.css(c.elem,a)),r=1,h=20;if(e&&e[3]!==n){n=n||e[3];d=d||[];e=+j||1;do r=r||".5",e/=r,f.style(c.elem,a,e+n);while(r!==(r=c.cur()/j)&&1!==r&&--h)}d&&(e=c.start=+e||+j||0,c.unit=n,c.end=d[1]?e+(d[1]+1)*d[2]:+d[2]);return c}]};f.Animation=f.extend(jb,{tweener:function(a,b){f.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,j=0,d=a.length;j<
d;j++)c=a[j],ib[c]=ib[c]||[],ib[c].unshift(b)},prefilter:function(a,b){b?tb.unshift(a):tb.push(a)}});f.speed=function(a,b,c){var j=a&&"object"===typeof a?f.extend({},a):{complete:c||!c&&b||f.isFunction(a)&&a,duration:a,easing:c&&b||b&&!f.isFunction(b)&&b};j.duration=f.fx.off?0:"number"===typeof j.duration?j.duration:j.duration in f.fx.speeds?f.fx.speeds[j.duration]:f.fx.speeds._default;if(null==j.queue||!0===j.queue)j.queue="fx";j.old=j.complete;j.complete=function(){f.isFunction(j.old)&&j.old.call(this);
j.queue&&f.dequeue(this,j.queue)};return j};f.fn.extend({fadeTo:function(a,b,c,j){return this.filter(hb).css("opacity",0).show().end().animate({opacity:b},a,c,j)},animate:function(a,b,c,j){var d=f.isEmptyObject(a),n=f.speed(b,c,j);b=function(){var b=jb(this,f.extend({},a),n);(d||f._data(this,"finish"))&&b.stop(!0)};b.finish=b;return d||!1===n.queue?this.each(b):this.queue(n.queue,b)},stop:function(a,b,c){var j=function(a){var b=a.stop;delete a.stop;b(c)};"string"!==typeof a&&(c=b,b=a,a=void 0);b&&
!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var b=!0,d=null!=a&&a+"queueHooks",n=f.timers,e=f._data(this);if(d)e[d]&&e[d].stop&&j(e[d]);else for(d in e)e[d]&&(e[d].stop&&Kd.test(d))&&j(e[d]);for(d=n.length;d--;)if(n[d].elem===this&&(null==a||n[d].queue===a))n[d].anim.stop(c),b=!1,n.splice(d,1);(b||!c)&&f.dequeue(this,a)})},finish:function(a){!1!==a&&(a=a||"fx");return this.each(function(){var b,c=f._data(this),j=c[a+"queue"];b=c[a+"queueHooks"];var d=f.timers,n=j?j.length:0;c.finish=
!0;f.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=d.length;b--;)d[b].elem===this&&d[b].queue===a&&(d[b].anim.stop(!0),d.splice(b,1));for(b=0;b<n;b++)j[b]&&j[b].finish&&j[b].finish.call(this);delete c.finish})}});f.each(["toggle","show","hide"],function(a,b){var c=f.fn[b];f.fn[b]=function(a,g,j){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(N(b,!0),a,g,j)}});f.each({slideDown:N("show"),slideUp:N("hide"),slideToggle:N("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},
...
f.fn.delay=function(a,b){a=f.fx?f.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,c){var j=setTimeout(b,a);c.stop=function(){clearTimeout(j)}})};var Ib,Ka,fc,gc,qb=y.createElement("div");qb.setAttribute("className","t");qb.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";Ib=qb.getElementsByTagName("a")[0];fc=y.createElement("select");gc=fc.appendChild(y.createElement("option"));Ka=qb.getElementsByTagName("input")[0];Ib.style.cssText="top:1px";w.getSetAttribute=
"t"!==qb.className;w.style=/top/.test(Ib.getAttribute("style"));w.hrefNormalized="/a"===Ib.getAttribute("href");w.checkOn=!!Ka.value;w.optSelected=gc.selected;w.enctype=!!y.createElement("form").enctype;fc.disabled=!0;w.optDisabled=!gc.disabled;Ka=y.createElement("input");Ka.setAttribute("value","");w.input=""===Ka.getAttribute("value");Ka.value="t";Ka.setAttribute("type","radio");w.radioValue="t"===Ka.value;var Ld=/\r/g;f.fn.extend({val:function(a){var b,c,j,d=this[0];if(arguments.length)return j=
f.isFunction(a),this.each(function(c){if(1===this.nodeType&&(c=j?a.call(this,c,f(this).val()):a,null==c?c="":"number"===typeof c?c+="":f.isArray(c)&&(c=f.map(c,function(a){return null==a?"":a+""})),b=f.valHooks[this.type]||f.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||void 0===b.set(this,c,"value")))this.value=c});if(d){if((b=f.valHooks[d.type]||f.valHooks[d.nodeName.toLowerCase()])&&"get"in b&&void 0!==(c=b.get(d,"value")))return c;c=d.value;return"string"===typeof c?c.replace(Ld,""):
null==c?"":c}}});f.extend({valHooks:{option:{get:function(a){var b=f.find.attr(a,"value");return null!=b?b:f.text(a)}},select:{get:function(a){for(var b,c=a.options,j=a.selectedIndex,d=(a="select-one"===a.type||0>j)?null:[],n=a?j+1:c.length,e=0>j?n:a?j:0;e<n;e++)if(b=c[e],(b.selected||e===j)&&(w.optDisabled?!b.disabled:null===b.getAttribute("disabled"))&&(!b.parentNode.disabled||!f.nodeName(b.parentNode,"optgroup"))){b=f(b).val();if(a)return b;d.push(b)}return d},set:function(a,b){for(var c,j,d=a.options,
n=f.makeArray(b),e=d.length;e--;)if(j=d[e],0<=f.inArray(f.valHooks.option.get(j),n))try{j.selected=c=!0}catch(r){j.scrollHeight}else j.selected=!1;c||(a.selectedIndex=-1);return d}}}});f.each(["radio","checkbox"],function(){f.valHooks[this]={set:function(a,b){if(f.isArray(b))return a.checked=0<=f.inArray(f(a).val(),b)}};w.checkOn||(f.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var cb,Lc,La=f.expr.attrHandle,hc=/^(?:checked|selected)$/i,Wa=w.getSetAttribute,
Jb=w.input;f.fn.extend({attr:function(a,b){return Va(this,f.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){f.removeAttr(this,a)})}});f.extend({attr:function(a,b,c){var j,d,n=a.nodeType;if(a&&!(3===n||8===n||2===n)){if(typeof a.getAttribute===la)return f.prop(a,b,c);if(1!==n||!f.isXMLDoc(a))b=b.toLowerCase(),j=f.attrHooks[b]||(f.expr.match.bool.test(b)?Lc:cb);if(void 0!==c)if(null===c)f.removeAttr(a,b);else{if(j&&"set"in j&&void 0!==(d=j.set(a,c,b)))return d;a.setAttribute(b,
c+"");return c}else{if(j&&"get"in j&&null!==(d=j.get(a,b)))return d;d=f.find.attr(a,b);return null==d?void 0:d}}},removeAttr:function(a,b){var c,j,d=0,n=b&&b.match(va);if(n&&1===a.nodeType)for(;c=n[d++];)j=f.propFix[c]||c,f.expr.match.bool.test(c)?Jb&&Wa||!hc.test(c)?a[j]=!1:a[f.camelCase("default-"+c)]=a[j]=!1:f.attr(a,c,""),a.removeAttribute(Wa?c:j)},attrHooks:{type:{set:function(a,b){if(!w.radioValue&&"radio"===b&&f.nodeName(a,"input")){var c=a.value;a.setAttribute("type",b);c&&(a.value=c);return b}}}}});
Lc={set:function(a,b,c){!1===b?f.removeAttr(a,c):Jb&&Wa||!hc.test(c)?a.setAttribute(!Wa&&f.propFix[c]||c,c):a[f.camelCase("default-"+c)]=a[c]=!0;return c}};f.each(f.expr.match.bool.source.match(/\w+/g),function(a,b){var c=La[b]||f.find.attr;La[b]=Jb&&Wa||!hc.test(b)?function(a,b,g){var j,f;g||(f=La[b],La[b]=j,j=null!=c(a,b,g)?b.toLowerCase():null,La[b]=f);return j}:function(a,b,g){if(!g)return a[f.camelCase("default-"+b)]?b.toLowerCase():null}});if(!Jb||!Wa)f.attrHooks.value={set:function(a,b,c){if(f.nodeName(a,
"input"))a.defaultValue=b;else return cb&&cb.set(a,b,c)}};Wa||(cb={set:function(a,b,c){var j=a.getAttributeNode(c);j||a.setAttributeNode(j=a.ownerDocument.createAttribute(c));j.value=b+="";if("value"===c||b===a.getAttribute(c))return b}},La.id=La.name=La.coords=function(a,b,c){var j;if(!c)return(j=a.getAttributeNode(b))&&""!==j.value?j.value:null},f.valHooks.button={get:function(a,b){var c=a.getAttributeNode(b);if(c&&c.specified)return c.value},set:cb.set},f.attrHooks.contenteditable={set:function(a,
...
c,j,d,n,e=0,r=this.length;b="string"===typeof a&&a;if(f.isFunction(a))return this.each(function(b){f(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(va)||[];e<r;e++)if(c=this[e],j=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(ic," "):" ")){for(n=0;d=b[n++];)0>j.indexOf(" "+d+" ")&&(j+=d+" ");j=f.trim(j);c.className!==j&&(c.className=j)}return this},removeClass:function(a){var b,c,j,d,n,e=0,r=this.length;b=0===arguments.length||"string"===typeof a&&a;if(f.isFunction(a))return this.each(function(b){f(this).removeClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(va)||[];e<r;e++)if(c=this[e],j=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(ic," "):"")){for(n=0;d=b[n++];)for(;0<=j.indexOf(" "+d+" ");)j=j.replace(" "+d+" "," ");j=a?f.trim(j):"";c.className!==j&&(c.className=j)}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"===typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):f.isFunction(a)?this.each(function(c){f(this).toggleClass(a.call(this,c,this.className,b),b)}):
this.each(function(){if("string"===c)for(var b,j=0,d=f(this),n=a.match(va)||[];b=n[j++];)d.hasClass(b)?d.removeClass(b):d.addClass(b);else if(c===la||"boolean"===c)this.className&&f._data(this,"__className__",this.className),this.className=this.className||!1===a?"":f._data(this,"__className__")||""})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(ic," ").indexOf(a))return!0;return!1}});f.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
function(a,b){f.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});f.fn.extend({hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,j){return this.on(b,a,c,j)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}});var jc=f.now(),kc=/\?/,Od=/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
f.parseJSON=function(b){if(a.JSON&&a.JSON.parse)return a.JSON.parse(b+"");var c,j=null,d=f.trim(b+"");return d&&!f.trim(d.replace(Od,function(a,b,g,f){c&&b&&(j=0);if(0===j)return a;c=g||b;j+=!f-!g;return""}))?Function("return "+d)():f.error("Invalid JSON: "+b)};f.parseXML=function(b){var c,j;if(!b||"string"!==typeof b)return null;try{a.DOMParser?(j=new DOMParser,c=j.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b))}catch(d){c=void 0}(!c||!c.documentElement||
c.getElementsByTagName("parsererror").length)&&f.error("Invalid XML: "+b);return c};var Xa,Ma,Pd=/#.*$/,Mc=/([?&])_=[^&]*/,Qd=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Rd=/^(?:GET|HEAD)$/,Sd=/^\/\//,Nc=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Oc={},Nb={},Pc="*/".concat("*");try{Ma=location.href}catch(be){Ma=y.createElement("a"),Ma.href="",Ma=Ma.href}Xa=Nc.exec(Ma.toLowerCase())||[];f.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:Ma,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Xa[1]),
...
f.ajaxSettings),b):wa(f.ajaxSettings,a)},ajaxPrefilter:kb(Oc),ajaxTransport:kb(Nb),ajax:function(a,b){function c(a,b,g,j){var d,l,p,m;m=b;if(2!==fa){fa=2;r&&clearTimeout(r);k=void 0;e=j||"";t.readyState=0<a?4:0;j=200<=a&&300>a||304===a;if(g){p=q;for(var v=t,M,ia,E,C,U=p.contents,O=p.dataTypes;"*"===O[0];)O.shift(),void 0===ia&&(ia=p.mimeType||v.getResponseHeader("Content-Type"));if(ia)for(C in U)if(U[C]&&U[C].test(ia)){O.unshift(C);break}if(O[0]in g)E=O[0];else{for(C in g){if(!O[0]||p.converters[C+
" "+O[0]]){E=C;break}M||(M=C)}E=E||M}E?(E!==O[0]&&O.unshift(E),p=g[E]):p=void 0}a:{g=q;M=p;ia=t;E=j;var w,aa,u,v={},U=g.dataTypes.slice();if(U[1])for(aa in g.converters)v[aa.toLowerCase()]=g.converters[aa];for(C=U.shift();C;)if(g.responseFields[C]&&(ia[g.responseFields[C]]=M),!u&&(E&&g.dataFilter)&&(M=g.dataFilter(M,g.dataType)),u=C,C=U.shift())if("*"===C)C=u;else if("*"!==u&&u!==C){aa=v[u+" "+C]||v["* "+C];if(!aa)for(w in v)if(p=w.split(" "),p[1]===C&&(aa=v[u+" "+p[0]]||v["* "+p[0]])){!0===aa?aa=
v[w]:!0!==v[w]&&(C=p[0],U.unshift(p[1]));break}if(!0!==aa)if(aa&&g["throws"])M=aa(M);else try{M=aa(M)}catch(I){p={state:"parsererror",error:aa?I:"No conversion from "+u+" to "+C};break a}}p={state:"success",data:M}}if(j)q.ifModified&&((m=t.getResponseHeader("Last-Modified"))&&(f.lastModified[n]=m),(m=t.getResponseHeader("etag"))&&(f.etag[n]=m)),204===a||"HEAD"===q.type?m="nocontent":304===a?m="notmodified":(m=p.state,d=p.data,l=p.error,j=!l);else if(l=m,a||!m)m="error",0>a&&(a=0);t.status=a;t.statusText=
(b||m)+"";j?T.resolveWith(A,[d,m,t]):T.rejectWith(A,[t,m,l]);t.statusCode(L);L=void 0;h&&z.trigger(j?"ajaxSuccess":"ajaxError",[t,q,j?d:l]);s.fireWith(A,[t,m]);h&&(z.trigger("ajaxComplete",[t,q]),--f.active||f.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var j,d,n,e,r,h,k,l,q=f.ajaxSetup({},b),A=q.context||q,z=q.context&&(A.nodeType||A.jquery)?f(A):f.event,T=f.Deferred(),s=f.Callbacks("once memory"),L=q.statusCode||{},m={},M={},fa=0,ia="canceled",t={readyState:0,getResponseHeader:function(a){var b;
if(2===fa){if(!l)for(l={};b=Qd.exec(e);)l[b[1].toLowerCase()]=b[2];b=l[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===fa?e:null},setRequestHeader:function(a,b){var c=a.toLowerCase();fa||(a=M[c]=M[c]||a,m[a]=b);return this},overrideMimeType:function(a){fa||(q.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>fa)for(b in a)L[b]=[L[b],a[b]];else t.always(a[t.status]);return this},abort:function(a){a=a||ia;k&&k.abort(a);c(0,a);return this}};T.promise(t).complete=
s.add;t.success=t.done;t.error=t.fail;q.url=((a||q.url||Ma)+"").replace(Pd,"").replace(Sd,Xa[1]+"//");q.type=b.method||b.type||q.method||q.type;q.dataTypes=f.trim(q.dataType||"*").toLowerCase().match(va)||[""];null==q.crossDomain&&(j=Nc.exec(q.url.toLowerCase()),q.crossDomain=!(!j||!(j[1]!==Xa[1]||j[2]!==Xa[2]||(j[3]||("http:"===j[1]?"80":"443"))!==(Xa[3]||("http:"===Xa[1]?"80":"443")))));q.data&&(q.processData&&"string"!==typeof q.data)&&(q.data=f.param(q.data,q.traditional));ub(Oc,q,b,t);if(2===
fa)return t;(h=q.global)&&0===f.active++&&f.event.trigger("ajaxStart");q.type=q.type.toUpperCase();q.hasContent=!Rd.test(q.type);n=q.url;q.hasContent||(q.data&&(n=q.url+=(kc.test(n)?"&":"?")+q.data,delete q.data),!1===q.cache&&(q.url=Mc.test(n)?n.replace(Mc,"$1_="+jc++):n+(kc.test(n)?"&":"?")+"_="+jc++));q.ifModified&&(f.lastModified[n]&&t.setRequestHeader("If-Modified-Since",f.lastModified[n]),f.etag[n]&&t.setRequestHeader("If-None-Match",f.etag[n]));(q.data&&q.hasContent&&!1!==q.contentType||b.contentType)&&
...
q.timeout));try{fa=1,k.send(m,c)}catch(E){if(2>fa)c(-1,E);else throw E;}}else c(-1,"No Transport");return t},getJSON:function(a,b,c){return f.get(a,b,c,"json")},getScript:function(a,b){return f.get(a,void 0,b,"script")}});f.each(["get","post"],function(a,b){f[b]=function(a,c,g,j){f.isFunction(c)&&(j=j||g,g=c,c=void 0);return f.ajax({url:a,type:b,dataType:j,data:c,success:g})}});f.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){f.fn[b]=function(a){return this.on(b,
...
d),b.converters["script json"]=function(){e||f.error(d+" was not called");return e[0]},b.dataTypes[0]="json",n=a[d],a[d]=function(){e=arguments},j.always(function(){a[d]=n;b[d]&&(b.jsonpCallback=c.jsonpCallback,Rc.push(d));e&&f.isFunction(n)&&n(e[0]);e=n=void 0}),"script"});f.parseHTML=function(a,b,c){if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(c=b,b=!1);b=b||y;var j=xc.exec(a);c=!c&&[];if(j)return[b.createElement(j[1])];j=f.buildFragment([a],b,c);c&&c.length&&f(c).remove();return f.merge([],
j.childNodes)};var Sc=f.fn.load;f.fn.load=function(a,b,c){if("string"!==typeof a&&Sc)return Sc.apply(this,arguments);var j,d,n,e=this,r=a.indexOf(" ");0<=r&&(j=a.slice(r,a.length),a=a.slice(0,r));f.isFunction(b)?(c=b,b=void 0):b&&"object"===typeof b&&(n="POST");0<e.length&&f.ajax({url:a,type:n,dataType:"html",data:b}).done(function(a){d=arguments;e.html(j?f("<div>").append(f.parseHTML(a)).find(j):a)}).complete(c&&function(a,b){e.each(c,d||[a.responseText,b,a])});return this};f.expr.filters.animated=
function(a){return f.grep(f.timers,function(b){return a===b.elem}).length};var Tc=a.document.documentElement;f.offset={setOffset:function(a,b,c){var j,d,n,e=f.css(a,"position"),r=f(a),q={};"static"===e&&(a.style.position="relative");n=r.offset();d=f.css(a,"top");j=f.css(a,"left");("absolute"===e||"fixed"===e)&&-1<f.inArray("auto",[d,j])?(j=r.position(),d=j.top,j=j.left):(d=parseFloat(d)||0,j=parseFloat(j)||0);f.isFunction(b)&&(b=b.call(a,c,n));null!=b.top&&(q.top=b.top-n.top+d);null!=b.left&&(q.left=
b.left-n.left+j);"using"in b?b.using.call(a,q):r.css(q)}};f.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){f.offset.setOffset(this,a,b)});var b,c,j={top:0,left:0},d=(c=this[0])&&c.ownerDocument;if(d){b=d.documentElement;if(!f.contains(b,c))return j;typeof c.getBoundingClientRect!==la&&(j=c.getBoundingClientRect());c=ca(d);return{top:j.top+(c.pageYOffset||b.scrollTop)-(b.clientTop||0),left:j.left+(c.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}}},position:function(){if(this[0]){var a,
b,c={top:0,left:0},j=this[0];"fixed"===f.css(j,"position")?b=j.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),f.nodeName(a[0],"html")||(c=a.offset()),c.top+=f.css(a[0],"borderTopWidth",!0),c.left+=f.css(a[0],"borderLeftWidth",!0));return{top:b.top-c.top-f.css(j,"marginTop",!0),left:b.left-c.left-f.css(j,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||Tc;a&&!f.nodeName(a,"html")&&"static"===f.css(a,"position");)a=a.offsetParent;return a||
Tc})}});f.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c=/Y/.test(b);f.fn[a]=function(j){return Va(this,function(a,j,g){var d=ca(a);if(void 0===g)return d?b in d?d[b]:d.document.documentElement[j]:a[j];d?d.scrollTo(!c?g:f(d).scrollLeft(),c?g:f(d).scrollTop()):a[j]=g},a,j,arguments.length,null)}});f.each(["top","left"],function(a,b){f.cssHooks[b]=fb(w.pixelPosition,function(a,c){if(c)return c=Ra(a,b),sb.test(c)?f(a).position()[b]+"px":c})});f.each({Height:"height",Width:"width"},
function(a,b){f.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,j){f.fn[j]=function(j,d){var n=arguments.length&&(c||"boolean"!==typeof j),e=c||(!0===j||!0===d?"margin":"border");return Va(this,function(b,c,j){return f.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(c=b.documentElement,Math.max(b.body["scroll"+a],c["scroll"+a],b.body["offset"+a],c["offset"+a],c["client"+a])):void 0===j?f.css(b,c,e):f.style(b,c,j,e)},b,n?j:void 0,n,null)}})});f.fn.size=function(){return this.length};
...
s.responseText:null}catch(m){}try{e.binary=s.response}catch(t){}try{c=s.statusText}catch(u){c=""}!b&&a.isLocal&&!a.crossDomain?b=e.text?200:404:1223===b&&(b=204);k(b,c,e,d)}}catch(V){alert(V),k(-1,V)}};a.async?4===s.readyState?setTimeout(h):s.onreadystatechange=h:h()},abort:function(){}}}))})(jQuery);
...
Jmol._version||(Jmol=function(a){var m=function(a){return{rear:a++,header:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,consoleImage:a+91001,monitorZIndex:a+99999}},m={_version:"$Date: 2022-01-23 22:53:29 -0600 (Sun, 23 Jan 2022) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_appletCssClass:"",_appletCssText:"",_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_persistentMenu:!1,
...
!b&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=!1}return!0};a._binaryTypes="mmtf .gz .bz2 .jpg .gif .png .zip .jmol .bin .smol .spartan .pmb .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd .uk/pdbe/densities/".split(" ");a.isBinaryUrl=function(b){for(var c=a._binaryTypes.length;0<=--c;)if(0<=b.indexOf(a._binaryTypes[c]))return!0;return!1};a._getFileData=function(b,c,d){var e=a.isBinaryUrl(b),h=0<=b.indexOf(".gz")&&0<=b.indexOf("rcsb.org");h&&
(b=b.replace(/\.gz/,""),e=!1);var h=e&&!c&&!a._canSyncBinary(h),k=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var l=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),s="https://"==a._httpProto&&0==b.indexOf("http://"),m=a._isDirectCall(b);!m&&0<=b.indexOf("?ALLOWSORIGIN?")&&(m=!0,b=b.replace(/\?ALLOWSORIGIN\?/,""));var t=!l&&a.$supportsIECrossDomainScripting(),u=null;if(s||h||!l&&!m||!c&&t)u=
a._getRawDataFromServer("_",b,c,c,h,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var P={dataType:e?"binary":"text",async:!!c};k?(P.type="POST",P.url=b.split("?POST?")[0],P.data=b.split("?POST?")[1]):(P.type="GET",P.url=b);c&&(P.success=function(){c(a._xhrReturn(P.xhr))},P.error=function(){c(P.xhr.statusText)});P.xhr=a.$ajax(P);c||(u=a._xhrReturn(P.xhr))}if(!d)return u;null==u&&(u="",e=!1);e&&(e=a._canSyncBinary(!0));return e?a._strToBytes(u):JU.SB.newS(u)};a._xhrReturn=function(a){return!a.responseText||
...
b._scriptLoad(h)}catch(k){}else e=new FileReader,e.onloadend=function(e){if(e.target.readyState==FileReader.DONE){var k="cache://DROP_"+h.name;e=Clazz.newByteArray(-1,e.target.result);"console_input"==c?(k=String.instantialize(e),a.$(b,c).val(0>k.indexOf("\x00")?k:e.length+" bytes")):(k.endsWith(".spt")||b._appletPanel.cacheFileByName("cache://DROP_*",!1),"JSV"==b._viewType||k.endsWith(".jdx")?a.Cache.put(k,e):b._appletPanel.cachePut(k,e),(e=a._jsGetXY(b._canvas,d))&&(!b._appletPanel.setStatusDragDropped||
b._appletPanel.setStatusDragDropped(0,e[0],e[1],k))&&b._appletPanel.openFileAsyncSpecial(k,1))}},e.readAsArrayBuffer(h)})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
m);s.src="string"==typeof k?k:"data:"+JU.Rdr.guessMimeTypeForBytes(k)+";base64,"+JU.Base64.getBase64(k)}var u=s.width,V=s.height;"webgl"==e&&(u/=2,V/=2);t=a.getHiddenCanvas(b.vwr.html5Applet,m,u,V,!0,!1);t.imageWidth=u;t.imageHeight=V;t.id=m;t.image=s;a.setCanvasImage(t,u,V)}else System.out.println("Jsmol.js Jmol.loadImage reading cached image for "+m);return null==k?l(t,h):t};a._canvasCache={};a.getHiddenCanvas=function(b,e,h,k,l,s){e=b._id+"_"+e;b=a._canvasCache[e];if(s)return b;if(l||!b||b.width!=
...
10)}}};h._notifyAudioEnded=function(a){this._applet.notifyAudioEnded(a)};h._readyCallback=function(e,h,l){if(l){a._setDestroy(this);this._ready=!0;e=this._readyScript;this._defaultModel?a._search(this,this._defaultModel,e?";"+e:""):e?this._script(e):this._src&&this._script('load "'+this._src+'"');this._showInfo(!0);this._showInfo(!1);a.Cache.setDragDrop(this,"appletdiv");this._readyFunction&&this._readyFunction(this);a._setReady(this);if((e=this._2dapplet)&&e._isEmbedded&&e._ready&&e.__Info.visible)this._show2d(!0),
...
this._2dapplet._isEmbedded&&(this._showInfo(!1),this._show(!a),this._2dapplet.__showContainer(!0,!0))};h._getSpinner=function(){return this.__Info.appletLoadingImage||this._j2sPath+"/img/JSmol_spinner.gif"};h._getAtomCorrelation=function(a,h){var l=this._evaluate("{*}.count");if(0!=l){this._loadMolData(a,"atommap = compare({1.1} {2.1} 'MAP' "+(h?"":"'H'")+"); zap 2.1",!0);for(var m=this._evaluate("atommap"),u=[],b=[],c=0;c<m.length;c++){var d=m[c];u[d[0]+1]=d[1]-l+1;b[d[1]-l+1]=d[0]+1}return{fromJmol:u,
toJmol:b}}};h._show=function(e){var h=!e?2:"100%";a.$setSize(a.$(this,"object"),h,h);this._isJava||a.$setVisible(a.$(this,"appletdiv"),e)};h._clearConsole=function(){this._console==this._id+"_infodiv"&&(this.info="");self.Clazz&&(a._setConsoleDiv(this._console),Clazz.Console.clear())};h._addScript=function(a){this._readyScript||(this.readyScript="");this._readyScript&&(this._readyScript+=";");this._readyScript+=a;return!0};h._setCallback=function(a,h){this._applet.setCallback(a,h)};h._script=function(e){if(!this._ready)return this._addScript(e);
a._setConsoleDiv(this._console);a._hideLocalFileReader(this);this._applet.script(e)};h._syncScript=function(a){this._applet.syncScript(a)};h._scriptCheck=function(a){return this._ready&&this._applet.scriptCheck(a)};h._scriptWait=function(a,h){var l=this._scriptWaitAsArray(a),m="";if(!h)for(var u=l.length;0<=--u;)for(var b=0,c=l[u].length;b<c;b++)m+=l[u][b]+"\n";return m};h._scriptEcho=function(a){a=this._scriptWaitAsArray(a);for(var h="",l=a.length;0<=--l;)for(var m=a[l].length;0<=--m;)"scriptEcho"==
a[l][m][1]&&(h+=a[l][m][3]+"\n");return h.replace(/ \| /g,"\n")};h._scriptMessage=function(a){a=this._scriptWaitAsArray(a);for(var h="",l=a.length;0<=--l;)for(var m=a[l].length;0<=--m;)"scriptStatus"==a[l][m][1]&&(h+=a[l][m][3]+"\n");return h.replace(/ \| /g,"\n")};h._scriptWaitOutput=function(a){var h="";try{a&&(h+=this._applet.scriptWaitOutput(a))}catch(l){}return h};h._scriptWaitAsArray=function(e){var h="";try{if(this._getStatus("scriptEcho,scriptMessage,scriptStatus,scriptError"),e&&(h+=this._applet.scriptWait(e),
h=a._evalJSON(h,"jmolStatus"),"object"==typeof h))return h}catch(l){}return[[h]]};h._getStatus=function(e){return a._sortMessages(this._getPropertyAsArray("jmolStatus",e))};h._getPropertyAsArray=function(e,h){return a._evalJSON(this._getPropertyAsJSON(e,h),e)};h._getPropertyAsString=function(a,h){void 0==h&&(h="");return this._applet.getPropertyAsString(a,h)+""};h._getPropertyAsJSON=function(a,h){void 0==h&&(h="");try{return this._applet.getPropertyAsJSON(a,h)+""}catch(l){return""}};h._getPropertyAsJavaObject=
function(a,h){void 0==h&&(h="");return this._applet.getProperty(a,h)};h._evaluate=function(a){null!=a||(a="");return this._getPropertyAsArray("variableInfo",a)};h._evaluateDEPRECATED=function(a){a=""+this._getPropertyAsJavaObject("evaluate",a);var h=a.replace(/\-*\d+/,"");if(""==h&&!isNaN(parseInt(a)))return parseInt(a);h=a.replace(/\-*\d*\.\d*/,"");return""==h&&!isNaN(parseFloat(a))?parseFloat(a):a};h._saveOrientation=function(a){return this._savedOrientations[a]=this._getPropertyAsArray("orientationInfo",
"info").moveTo};h._restoreOrientation=function(a){a=this._savedOrientations[a];return!a||""==a?a.replace(/1\.0/,"0"):this._scriptWait(a)};h._restoreOrientationDelayed=function(a,h){1>arguments.length&&(h=1);var l=this._savedOrientations[a];return!l||""==l?l.replace(/1\.0/,h):this._scriptWait(l)};h._resizeApplet=function(e){function h(e,l){var b=""+e;return 0==b.length?l?"":a._allowedJmolSize[2]:b.indexOf("%")==b.length-1?b:1>=(e=parseFloat(e))&&0<e?100*e+"%":(isNaN(e=Math.floor(e))?a._allowedJmolSize[2]:
e<a._allowedJmolSize[0]?a._allowedJmolSize[0]:e>a._allowedJmolSize[1]?a._allowedJmolSize[1]:e)+(l?l:"")}var l;"object"==typeof e&&null!=e?(l=e[0]||e.width,e=e[1]||e.height):l=e;l=[h(l,"px"),h(e,"px")];e=a._getElement(this,"appletinfotablediv");e.style.width=l[0];e.style.height=l[1];this._containerWidth=l[0];this._containerHeight=l[1];this._is2D&&a.repaint(this,!0)};h._search=function(e,h){a._search(this,e,h)};h._searchDatabase=function(e,h,l){if(this._2dapplet&&this._2dapplet._isEmbedded&&!a.$(this,
...
c&&("function"!=typeof b[c]||!s(b,c)))a[c]=a.prototype[c]=b[c]};a.extendInterface=a.implementOf;a.equalsOrExtendsLevel=function(b,c){if(b===c)return 0;if(b.implementz)for(var d=b.implementz,e=0;e<d.length;e++){var h=a.equalsOrExtendsLevel(d[e],c);if(0<=h)return h+1}return-1};a.getInheritedLevel=function(b,c){if(b===c)return 0;var d="string"==typeof b;if(d&&("void"==b||"unknown"==b))return-1;var e="string"==typeof c;if(e&&("void"==c||"unknown"==c))return-1;if(b===(d?"NullObject":NullObject))switch(c){case "n":case "b":return-1;
...
[];var b=function(){this.toString=function(){return"J2S MethodException"}},c;try{null.hello()}catch(d){if(k=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var k=d.message.indexOf(":"),q=d.message.indexOf(":",k+2),L=d.message.substr(k+1,q-k-20);c=function(a){return-1!=a.message.indexOf(L)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var U=k(d.message,"hello");
c=function(a){return U.test(a.message)}}else U=k(d.message,"$$o$$"),c=function(a){return U.test(a.message)}}a.exceptionOf=function(b,d){if(b.__CLASS_NAME__)return a.instanceOf(b,d);b.getMessage||(b.getMessage=function(){return""+b+(b.stack?"\n"+b.stack:"")});b.printStackTrace||(b.printStackTrace=function(){});if(d==Error){if(0>(""+b).indexOf("Error"))return!1;System.out.println(a.getStackTrace());return!0}return d==Exception||d==Throwable||d==NullPointerException&&c(b)};a.getStackTrace=function(a){a||
...
a.makeConstructor=function(b,c,d){a.defineMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.overrideConstructor=function(b,c,d){a.overrideMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.defineMethod=function(c,d,h,k){h.exName=d;k=Ca(k);var l=c.prototype,m=l[d];a._Loader._checkLoad&&C(c,d,k);if(!m||m.claxxOwner===c&&m.funParams==k)return h.funParams=k,h.claxxOwner=c,h.exClazz=c,l[d]=h;var q=null,s=m.stacks;s||(s=[],q=m,m.claxxOwner&&
(s[0]=q.claxxOwner));if(!m.stacks||m.claxxReference!==c){++P;m=function(){var c;a:{var d=arguments.callee.claxxReference,j=arguments.callee.methodName;c=arguments;fx=this[j];var h=a.getParamsType(c);if(!fx)try{System.out.println(a.getStackTrace(5))}catch(n){}if(e){var r=d.__CLASS_NAME__+" "+j+" ";0>V.indexOf(r)&&(V+=r+"\n");e[r]||(e[r]=0);e[r]++}if(fx.lastParams==h.typeString&&fx.lastClaxxRef===d){if(h.hasCastedNull){d=[];for(j=0;j<c.length;j++)d[j]=c[j]instanceof a.CastedNull?null:c[j]}else d=c;
c=fx.lastMethod?fx.lastMethod.apply(this,d):null}else{fx.lastParams=h.typeString;fx.lastClaxxRef=d;r=fx.stacks;r||(r=d.prototype[j].stacks);for(var k=!1,l=r.length;0<=--l;)if(k||r[l]===d){var m=r[l].prototype[j],z=h,k=c,q=fx,s=[],t=!0,E=void 0;for(E in m)if(92==E.charCodeAt(0)){var u=E.substring(1).split("\\");u.length==z.length&&s.push(u);t=!1}else if(t&&"funParams"==E&&m.funParams){E=m.funParams;u=E.substring(1).split("\\");u.length==z.length&&(s[0]=u);break}E=void 0;if(!(E=0==s.length)){E=void 0;
for(var E=[],O=s.length,u=0;u<O;u++){for(var x=[],xa=!0,C=s[u].length,B=0;B<C;B++)if(x[B]=a.getInheritedLevel(z[B],s[u][B]),0>x[B]){xa=!1;break}xa&&(x[z.length]=u,E.push(x))}if(0==E.length)E=null;else{O=E[0];for(u=1;u<E.length;u++){x=!0;for(B=0;B<z.length;B++)if(O[B]<E[u][B]){x=!1;break}x&&(O=E[u])}E=s[O[z.length]].join("\\")}E=!(s=E)}if(E)k=new b;else{m=t?m:m["\\"+s];t=null;if(z.hasCastedNull){t=[];for(z=0;z<k.length;z++)t[z]=k[z]instanceof a.CastedNull?null:k[z]}else t=k;q.lastMethod=m;k=m.apply(this,
t)}if(!(k instanceof b)){c=k;break a}k=!0}"construct"!=j&&fb(this,d,j,h.typeString);c=void 0}}return c};m.methodName=d;m.claxxReference=c;m=l[d]=m;d=[];for(l=0;l<s.length;l++)d[l]=s[l];m.stacks=d}s=m.stacks;0>rb(s,c)&&s.push(c);q&&(q.claxxOwner===c?(m[q.funParams]=q,q.claxxOwner=null,q.funParams=null):q.claxxOwner||(m["\\unknown"]=q));h.exClazz=c;m[k]=h;return m};duplicatedMethods={};var C=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||e.claxxReference)===b)key=b.__CLASS_NAME__+"."+c+d,
...
c.substring(0,e+1),e=d.split(/\./),h=1;h<e.length;h++){for(var k="/",l=0;l<h;l++)k+=e[l]+"/";if(k.length>c.length)break;if(c.indexOf(k)==c.length-k.length){c=c.substring(0,c.length-k.length+1);break}}else c=a._Loader.getClasspathFor(d,!0);else(e=a.binaryFolders)&&e.length&&(c=e[0]);c||(c="j2s/");c=c.replace(/\\/g,"/");e=c.length;e=c.charAt(e-1);"/"!=e&&(c+="/");this.base?d=c+b:(e=d.lastIndexOf("."),d=-1==e||this.base?c+b:c+d.substring(0,e).replace(/\./g,"/")+"/"+b)}c=null;try{if(0>d.indexOf(":/")){var q=
...
var fb=function(b,c,d,e){b="";e&&(b=e.substring(1).replace(/\\/g,","));c=(d&&"construct"!=d?"Method":"Constructor")+" "+a.getClassName(c,!0)+"."+d+"("+b+") is not found!";throw new java.lang.NoSuchMethodException(c);};a.prepareCallback=function(b,c){var d=c[0];if(b&&d&&d!==window){var e=a.getClassName(d,!0),h={};if(b.b$)for(var k in b.b$)h[k]=b.b$[k];b.b$=h;h[e]=d;for(e=a.getClass(d);e.superClazz;)e=e.superClazz,h[a.getClassName(e,!0)]=d;if(d=d.b$)for(k in d)h[k]=d[k]}for(h=0;h<c.length-1;h++)c[h]=
...
Float64Array.prototype.toString=function(){return"[object Float64Array]"});Float64Array.prototype.slice||(Float64Array.prototype.slice=function(){return ta.apply(this,arguments)});Float64Array.prototype.clone=function(){return this.slice()};a.newArray=function(a,b,c,d){if(-1!=a||2==arguments.length)return ma(arguments,0);a=b.slice(c,d);a.BYTES_PER_ELEMENT=b.BYTES_PER_ELEMENT;return a};var ma=function(a,b){var c=a[0];"string"==typeof c&&(c=c.charCodeAt(0));var d=a.length-1,e=a[d];if(1<d){for(var e=
...
64)};a.newDoubleArray=a.newFloatArray;a.newLongArray=a.newShortArray=a.newIntArray;a.newCharArray=a.newBooleanArray=a.newArray;!0==(a.haveInt8=!!self.Int8Array)?(Int8Array.prototype.sort||(Int8Array.prototype.sort=Array.prototype.sort),Int8Array.prototype.slice||(Int8Array.prototype.slice=function(){return ta.apply(this,arguments)})):a.newByteArray=a.newIntArray;Int8Array.prototype.clone=function(){var a=this.slice();a.BYTES_PER_ELEMENT=1;return a};a.isAB=function(a){return a&&"object"==typeof a&&
...
a[1],a[2],a[3]);default:for(var b="new "+this.__CLASS_NAME__+"(",c=0;c<a.length;c++)b+=(0==c?"":",")+"a["+c+"]";return eval(b+")")}};k=a.innerFunctionNames;for(q=0;q<k.length;q++)a._O[k[q]]=a._innerFunctions[k[q]],Array[k[q]]=a._innerFunctions[k[q]];a._Loader=a.ClazzLoader=function(){};var x=function(){this.parents=[];this.musts=[];this.optionals=[];this.onLoaded=this.path=this.name=this.declaration=null;this.status=0;this.random=0.13412};(function(a,b){b._checkLoad=m._checkLoad;b.updateNodeForFunctionDecoration=
function(a){(a=G(a))&&a.status==x.STATUS_KNOWN&&window.setTimeout(function(a){return function(){updateNode(a)}}(a),1)};x.prototype.toString=function(){return this.name||this.path||"ClazzNode"};x.STATUS_UNKNOWN=0;x.STATUS_KNOWN=1;x.STATUS_CONTENT_LOADED=2;x.STATUS_MUSTS_LOADED=3;x.STATUS_DECLARED=4;x.STATUS_LOAD_COMPLETE=5;var c=[];b.requireLoaderByBase=function(a){for(var d=0;d<c.length;d++)if(c[d].base==a)return c[d];d=new b;d.base=a;c.push(d);return d};var d=new x,e={},h=0,k=6,l=navigator.userAgent.toLowerCase(),
q=-1!=l.indexOf("opera"),s=-1!=l.indexOf("msie")&&!q,f=-1!=l.indexOf("gecko");if(q&&(k=1,q=l.indexOf("opera/"),-1!=q)){var t=9;try{t=parseFloat(l.subString(q+6))}catch(u){}9.6<=t&&(k=6)}var B;self.Clazz&&a.isClassDefined?isClassDefined=a.isClassDefined:(B={},isClassDefined=function(a){return!0==B[a]});var C=function(a){if(!a||0==a.length)return[];for(var b=null,c=0;c<a.length;c++)if(a[c]){if("$"==a[c].charAt(0))if("."==a[c].charAt(1)){if(!b)continue;var d=b.lastIndexOf(".");-1!=d&&(b=b.substring(0,
d),a[c]=b+a[c].substring(1))}else a[c]="org.eclipse.s"+a[c].substring(1);b=a[c]}return a},H=[],D={},L=0;b.loadPackageClasspath=function(a,c,d,e,f,h){f||(f=0);e||(e=null);h||(h=0);var j=d&&D["@"+a];if(0==f&&(d&&!D["@java"]&&0!=a.indexOf("java")&&null!=window["java.registered"]&&!D["@java"])&&(b.loadPackage("java",e?function(){b.loadPackageClasspath(a,c,d,e,1)}:null),e))return;if(a instanceof Array)if(C(a),e)h<a.length?b.loadPackageClasspath(a[h],c,d,function(){b.loadPackageClasspath(a,c,d,e,1,h+1)},
1):e();else for(j=0;j<a.length;j++)b.loadPackageClasspath(a[j],c,d,null);else{switch(a){case "java.*":a="java";case "java":c&&(f="@net.sf.j2s.ajax",D[f]||(D[f]=c),f="@net.sf.j2s",D[f]||(D[f]=c));break;case "swt":a="org.eclipse.swt";break;case "ajax":a="net.sf.j2s.ajax";break;case "j2s":a="net.sf.j2s";break;default:a.lastIndexOf(".*")==a.length-2&&(a=a.substring(0,a.length-2))}c&&(D["@"+a]=c);d&&!j&&!window[a+".registered"]?(L++,"java"==a&&(a="core"),b.loadClass(a+".package",function(){0==--L&&da()},
!0,!0,1)):e&&e()}};a.loadClass=function(c,d,e){self.Class||(Class=a,Class.forName=a._4Name,JavaObject=a._O);return c&&b.loadClass(c,d,!0,e,1)};b.loadClass=function(c,f,h,k,l){l||(l=0);null==k&&(k=!1);if("boolean"==typeof f)return a.evalType(c);null!=window["java.registered"]&&!D["@java"]&&b.loadPackage("java");b.keepOnLoading=!0;if(!h&&(L&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(ea)))Ja.push([c,f]),System.out.println("loadclass-queuing"+c+ea+" "+isClassDefined(ea));
else if((l=isClassDefined(c))||N["@"+c]){if(l&&f&&(h=G(c),!h||h.status>=x.STATUS_LOAD_COMPLETE))k?window.setTimeout(f,25):f()}else{var m=b.getClasspathFor(c);l=e[m];if(!l)for(k=H.length;0<=--k;)if(H[k].path==m||H[k].name==c){l=!0;break}if(l){if(f&&(l=G(c)))if(l.onLoaded){if(f!=l.onLoaded){var r=l.onLoaded,q=f;l.onLoaded=function(){r();q()}}}else l.onLoaded=f}else{l=a.unloadedClasses[c]&&G(c)||new x;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;Z(m,c,l);l.onLoaded=f;l.status=
x.STATUS_KNOWN;c=!1;for(k=H.length;0<=--k;)if(H[k].status!=x.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(k=H.length;0<=--k&&!H[k].isPackage;)H[k+1]=H[k];H[++k]=l}else c&&H.push(l);if(!c){var s=!1;f&&(s=ha,ha=!0);h&&(f=null);Ha(d,l,!0);W(l,l.path,l.requiredBy,!1,f?function(){ha=s;f()}:null)}}}};b.loadPackage=function(a,c){c||(c=null);window[a+".registered"]=!1;b.loadPackageClasspath(a,b.J2SLibBase||(b.J2SLibBase=b.getJ2SLibBase()||"j2s/"),!0,c)};b.jarClasspath=function(a,b){b instanceof Array||
(b=[b]);C(b);m._debugCore&&(a=a.replace(/\.z\./,"."));for(var c=b.length;0<=--c;)D["#"+b[c]]=a;D["$"+a]=b};b.registerPackages=function(c,d){for(var e=b.getClasspathFor(c+".*",!0),f=0;f<d.length;f++)window.Clazz&&a.declarePackage(c+"."+d[f]),b.loadPackageClasspath(c+"."+d[f],e)};b.getClasspathFor=function(c,d,e){var f=D["#"+c];if(!f||d||e){var h,k;if(f){if(c=c.replace(/\./g,"/"),0<=(k=f.lastIndexOf(c))||0<=(k=c.lastIndexOf("/"))&&0<=(k=f.lastIndexOf(c.substring(0,k))))h=f.substring(0,k)}else{for(k=
c.length+2;0<=(k=c.lastIndexOf(".",k-2))&&!(h=D["@"+c.substring(0,k)]););d||(c=c.replace(/\./g,"/"))}null==h&&(h=window.Clazz&&a.binaryFolders&&a.binaryFolders.length?a.binaryFolders[0]:b.binaryFolders&&b.binaryFolders.length?b.binaryFolders[0]:"j2s");f=(h.lastIndexOf("/")==h.length-1?h:h+"/")+(d?"":c.lastIndexOf("/*")==c.length-2?c.substring(0,k+1):c+(!e?".js":"."!=e.charAt(0)?"."+e:e))}return f};b.ignore=function(){var a=1==arguments.length&&arguments[0]instanceof Array?a=arguments[0]:null,b=a?
a.length:arguments.length;if(!a)for(var a=Array(b),c=0;c<b;c++)a[c]=arguments[c];C(a);for(c=0;c<b;c++)N["@"+a[c]]=1};b.onScriptLoading=function(){};b.onScriptLoaded=function(){};b.onScriptInitialized=function(){};b.onScriptCompleted=function(){};b.onClassUnloaded=function(){};b.onGlobalLoaded=function(){};b.keepOnLoading=!0;var S={},N={},U=function(c,d,e,f){if(!f)try{eval(e+";//# sourceURL="+c)}catch(h){if(a._isQuiet)return;c="[Java2Script] The required class file \n\n"+c+(0==e.indexOf("[Exception")&&
e.indexOf("data: no")?"\nwas not found.\n":"\ncould not be loaded. Script error: "+h.message+" \n\ndata:\n\n"+e)+"\n\n"+a.getStackTrace();alert(c);a.alert(c);throw h;}b.onScriptLoaded(c,!1);sa(d)},V=function(a){return function(){if("interactive"!=a.readyState){try{a.parentNode&&a.parentNode.removeChild(a)}catch(b){}a=null}}},X=function(a){window["j2s.script.debugging"]||window.setTimeout(V(a),1)};a._4Name=function(c,d,e){if(a.isClassDefined(c))return a.evalType(c);d=m._isAsync&&d?d._restoreState(c,
e):null;if(1==d)return null;if(b.setLoadingMode(d?b.MODE_SCRIPT:"xhr.sync"))return b.loadClass(c,d,!1,!0,1),null;b.loadClass(c);return a.evalType(c)};a.currentPath="";var W=function(c,d,f,k,l){a.currentPath=d;k&&alert("WHY>>");k=e[d];e[d]=!0;Ya(H,d);K=!0;ra=!1;b._checkLoad&&System.out.println("\t"+d+(f?"\n -- required by "+f:"")+"  ajax="+K+" async="+ra);f=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));k||System.out.println("loadScript "+d);b.onScriptLoading(d);if(K&&!ra){var r=m._getFileData(d);
try{U(d,f,r,k)}catch(q){alert(q+" loading file "+d+" "+c.name+" "+a.getStackTrace())}l&&l()}else c={dataType:"script",async:!0,type:"GET",url:d,success:ca(d,!1,l),error:ca(d,!0,l)},h++,k?setTimeout(c.success,0):m.$ajax(c)},ca=function(c,d,e){a.getStackTrace();return function(){f&&this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<h&&h--;this.onerror=this.onload=null;d&&alert("There was a problem loading "+c);b.onScriptLoaded(c,!0);var a=this,j;j=e?function(){X(a);
sa(c,e)}:function(){X(a);sa(c)};0<=Y?window.setTimeout(function(){sa(c,j)},Y):sa(c,j)}},ha=!0,ga=!1,sa=function(c,f){var l=S["@"+c];if(l){var m,r=D["$"+c];if(r)for(var q=0;q<r.length;q++){var t=r[q];if(t!=l.name&&(m=G(t)))m.status<x.STATUS_CONTENT_LOADED&&(m.status=x.STATUS_CONTENT_LOADED,updateNode(m));else{m=new x;m.name=t;var u=D["#"+t];u||(alert(t+" J2S error in tryToLoadNext"),error("Java2Script implementation error! Please report this bug!"));m.path=u;Z(m.path,t,m);m.status=x.STATUS_CONTENT_LOADED;
Ha(d,m,!1);updateNode(m)}}if(l instanceof Array)for(q=0;q<l.length;q++)l[q].status<x.STATUS_CONTENT_LOADED&&(l[q].status=x.STATUS_CONTENT_LOADED,updateNode(l[q]));else if(l.status<x.STATUS_CONTENT_LOADED){m=!1;r=document.getElementsByTagName("SCRIPT");for(q=0;q<r.length;q++)if(s){if(r[q].onreadystatechange&&r[q].onreadystatechange.path==l.path&&"interactive"==r[q].readyState){m=!0;break}}else if(r[q].onload&&r[q].onload.path==l.path){m=!0;break}m||(l.status=x.STATUS_CONTENT_LOADED,updateNode(l))}if(b.keepOnLoading){q=
!0;if(m=Ia(x.STATUS_KNOWN))for(R(m);h<k&&(m=Ia(x.STATUS_KNOWN));)R(m);else if(0!=H.length)m=H.shift(),!e[m.path]||0!=H.length||!ha||m.musts.length||m.optionals.length?(Ha(d,m,!0),W(m,m.path,m.requiredBy,!1)):ha&&(ha=!1);else if(m=F(x.STATUS_KNOWN))for(R(m);h<k&&(m=F(x.STATUS_KNOWN));)R(m);else q=!1;if(!(q||0<h)){l=[Ia,F];r=null;for(q=0;2>q;q++)for(;m=l[q](x.STATUS_CONTENT_LOADED);)1==q&&r===m&&(m.status=x.STATUS_LOAD_COMPLETE),updateNode(m),r=m;for(;!(ma=[],!na(d,c)););for(q=0;2>q;q++)for(r=null;(m=
l[q](x.STATUS_DECLARED))&&r!==m;)updateNode(r=m);r=[];for(q=0;2>q;q++)for(;m=l[q](x.STATUS_DECLARED);)r.push(m),m.status=x.STATUS_LOAD_COMPLETE;if(r.length){for(q=0;q<r.length;q++)Ba(r[q]);for(q=0;q<r.length;q++)if(l=r[q].onLoaded)r[q].onLoaded=null,l()}if(f)f();else if(b._classCountPending)for(t in b._classPending){if(m=G(t),System.out.println("class left pending "+t+" "+m),m){updateNode(m);break}}else b._checkLoad&&(System.out.println("I think I'm done: SAEM call count: "+P),a.showDuplicates(!0));
b.onGlobalLoaded()}}}},ma=[],na=function(a,c){var d=ma,e=d.length;d.push(a);for(var f=e;0<=--f&&!(d[f]===a&&d[f].status>=x.STATUS_DECLARED););if(0<=f){if(b._checkLoad){var h;System.out.println("cycle found loading "+c+" for "+a)}for(;f<e;f++){var j=d[f];j.status=x.STATUS_LOAD_COMPLETE;Ba(j);for(h=0;h<j.parents.length;h++)updateNode(j.parents[h]);j.parents=[];var k=j.onLoaded;b._checkLoad&&(h="cycle setting status to LOAD_COMPLETE for "+j.name+(k?" firing "+k.toString():""),System.out.println(h));
k&&(j.onLoaded=null,k())}d.length=0;return!0}j=[a.musts,a.optionals];for(h=0;2>h;h++){k=j[h];for(f=k.length;0<=--f;)if(k[f].status==x.STATUS_DECLARED&&na(k[f],c))return!0}d.length=e;return!1};b._classCountPending=0;b._classCountOK=0;b._classPending={};b.showPending=function(){var a=[],c;for(c in b._classPending){var d=G(c);d?(a.push(d),System.out.println(ta("","",d,"",0))):alert("No node for "+c)}return a};var ta=function(a,b,c,d,e){b+="--"+c.name;a+=b+"\n";if(5<e)return a+(d+" ...\n");d+="\t";a+=
d+"status: "+c.status+"\n";if(c.parents&&c.parents.length&&c.parents[0]&&c.parents[0].name){a+=d+"parents: "+c.parents.length+"\n";for(var f=0;f<c.parents.length;f++)a=ta(a,b,c.parents[f],d+"\t",e+1);a+="\n"}return a};updateNode=function(a){if(!a.name||a.status>=x.STATUS_LOAD_COMPLETE)Ba(a);else{var c=!0;if(a.musts.length&&a.declaration)for(var d=a.musts.length,e=d;0<=--e;){var f=a.musts[e];f.requiredBy=a;if(f.status<x.STATUS_DECLARED&&isClassDefined(f.name)){var h=[];f.status=x.STATUS_LOAD_COMPLETE;
...
a.status>x.STATUS_KNOWN&&!a.declaration||Ta(a.musts,x.STATUS_LOAD_COMPLETE)&&Ta(a.optionals,x.STATUS_LOAD_COMPLETE)){c=x.STATUS_LOAD_COMPLETE;if(!ua(a,c))return!1;if(a.declaration&&a.declaration.clazzList){j=0;k=a.declaration.clazzList;for(l=k.length;j<l;j++)if((m=G(k[j]))&&m.status!=c&&m!==a)if(m.declaration=null,!ua(m,c))return!1}}if(a.parents&&a.parents.length){for(e=0;e<a.parents.length;e++)j=a.parents[e],j.status<c&&updateNode(j,j.name);c==x.STATUS_LOAD_COMPLETE&&(a.parents=[])}}}};var Ta=function(a,
b){for(var c=a.length;0<=--c;)if(a[c].status<b)return!1;return!0},ua=function(a,c){a.status=c;b.onScriptCompleted(a.path);var d=a.onLoaded;if(d&&(a.onLoaded=null,d(),!b.keepOnLoading))return!1;Ba(a);return!0},wa={"r0.13412":1},za=function(){for(;;){var a=Math.random(),b="r"+a;if(!wa[b])return wa[b]=1,d.random=a}},G=function(a){za();return Ca(a,d)},F=function(a){za();return Aa(d,a)},Ia=function(a){return qa(d,a)},Ca=function(a,b){var c;return b.name==a?b:(c=$a(a,b.musts))||(c=$a(a,b.optionals))?c:
null},$a=function(a,b){for(var c=d.random,e=b.length;0<=--e;){var f=b[e];if(f.name==a||f.random!=c&&(f.random=c,f=Ca(a,f)))return f}return null},ya=function(a,b){return a.status==b&&(b!=x.STATUS_KNOWN||!e[a.path])&&(b==x.STATUS_DECLARED||!isClassDefined(a.name))},qa=function(a,b){for(var c=a.musts.length;0<=--c;){var d=a.musts[c];if(ya(d,b)||(d=qa(d,b)))return d}return ya(a,b)?a:null},Aa=function(a,b){var c;return(c=oa(a.musts,b))||(c=oa(a.optionals,b))||ya(c=a,b)?c:null},oa=function(a,b){if(a)for(var c=
d.random,e=0;e<a.length;e++){var f=a[e];if(ya(f,b)||f.random!=c&&(f.random=c,f=Aa(f,b)))return f}return null},Q=function(a,c,e,f){if(c instanceof Array){C(c);for(var h=0;h<c.length;h++)Q(a,c[h],e,f,c)}else{b._checkLoad&&!b._classPending[c]&&(b._classPending[c]=1,0==b._classCountPending++&&(b._classCountOK=0),System.out.println("Loading class "+c));h=S["#"+c];h||(h=(h=G(c))?h:new x,h.name=c,h.path=D["#"+c]||"unknown",Z(h.path,c,h),h.status=x.STATUS_KNOWN,Ha(d,h,!1));ja(h,a,!0);5==arguments.length&&
f&&(f.status=h.status,f.clazzList=arguments[4]);if(h.declaration=f)h.status=x.STATUS_CONTENT_LOADED;ja(h,e,!1)}},ja=function(a,b,c){if(b&&b.length){C(b);for(var d=0;d<b.length;d++){var e=b[d];if(e&&!isClassDefined(e)&&!N["@"+e]){var f=G(e);f||(f=new x,f.name=e,f.status=x.STATUS_KNOWN);f.requiredBy=a;Ha(a,f,c)}}}};window.Clazz?a.load=Q:b.load=Q;var Z=function(a,b,c){var d="@"+a;if(a=S[d])if(a instanceof Array){for(var d=!1,e=0;e<a.length;e++)if(a[e].name==b){d=!0;break}d||a.push(c)}else S[d]=[a,c];
else S[d]=c;S["#"+b]=c},R=function(a){var c=a.name;if(!isClassDefined(c)&&!N["@"+c]){var d=b.getClasspathFor(c);a.path=d;Z(d,c,a);if(!e[d])return W(a,d,a.requiredBy,!1),!0}return!1},ea=b.runtimeKeyClass="java.lang.String",Ja=[];b.getJ2SLibBase=function(){var a=window["j2s.lib"];return a?a.base+("."==a.alias?"":(a.alias?a.alias:a.version?a.version:"1.0.0")+"/"):null};var ra=!0,K=!1,Y=-1;b.MODE_SCRIPT=4;b.MODE_XHR=2;b.MODE_SYNC=1;b.setLoadingMode=function(a,c){var d=!0,e=!0;"string"==typeof a?(a=a.toLowerCase(),
0<=a.indexOf("script")?e=!1:a.indexOf("async"),d=!1):a&b.MODE_SCRIPT?e=!1:d=!(a&b.MODE_SYNC);K=e;Y=(ra=d)&&0<=c?c:-1;return d};var da=function(){if(!L&&isClassDefined(ea)){for(var a=Ja,c=0;c<a.length;c++)b.loadClass(a[c][0],a[c][1]);Ja=[]}};b.loadZJar=function(a,c){var d=null,e=c instanceof Array;e?c=c[c.length-1]:d=c==ea?da:null;b.jarClasspath(a,e?c:[c]);b.loadClass(c,d,!0)};var Da={},Oa=[],Ha=function(a,b,c){var e=!1;c?(c=a.musts,b.requiredBy||(b.requiredBy=a)):c=a.optionals;Da[b.name]||(Oa.push(b),
Da[b.name]=b);for(var f=0;f<c.length;f++)if(c[f].name==b.name){e=!0;break}e||(c.push(b),ha&&(0!=b.name.indexOf("java")&&0!=b.name.indexOf("net.sf.j2s.ajax"))&&(ga&&(ha=!1),ga=!0));a:{if(a.name&&a!=d&&a!=b)for(e=0;e<b.parents.length;e++)if(b.parents[e].name==a.name)break a;b.parents.push(a)}},Ba=function(a){var b=a.parents;if(b)for(var c=b.length;0<=--c;)Ya(b[c].musts,a)||Ya(b[c].optionals,a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var W=a._LoaderProgressMonitor,
H=null,ga=0,N=null,ua=0;W.DEFAULT_OPACITY=m&&m._j2sLoadMonitorOpacity?m._j2sLoadMonitorOpacity:55;W.hideMonitor=function(){N.style.display="none"};W.showStatus=function(a,b){if(!N){var c=document.createElement("DIV");c.id="_Loader-status";c.style.cssText="position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:"+(window["j2s.lib"].monitorZIndex||1E4)+";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";c.onmouseover=ub;N=c;document.body.appendChild(c);
wa||(wa=!0)}jb(N);if(null==a)b?na():W.hideMonitor();else{N.appendChild(document.createTextNode(""+a));"none"==N.style.display&&(N.style.display="");kb(W.DEFAULT_OPACITY);var d,c=navigator.userAgent;d=document.body;var e=d.parentNode,h=e.clientHeight;d=d.scrollTop+d.offsetTop;var k=e.scrollTop+e.offsetTop,c=0>c.indexOf("Opera")&&document.all?0==h?d:k:0>c.indexOf("Gecko")?h==e.offsetHeight&&h==e.scrollHeight?d:k:d;ua!=c&&(ua=c,N.style.bottom=ua+4+"px");b&&na()}};var jb=function(a){if(a)for(var b=a.childNodes.length;0<=
--b;){var c=a.childNodes[b];if(c){c.childNodes&&c.childNodes.length&&jb(c);try{a.removeChild(c)}catch(d){}}}},kb=function(a){H&&a==W.DEFAULT_OPACITY&&(window.clearTimeout(H),H=null);ga=a;navigator.userAgent.toLowerCase();N.style.filter="Alpha(Opacity="+a+")";N.style.opacity=a/100},ub=function(){W.hideMonitor()},wa=!1,na=function(){"none"!=N.style.display&&(ga==W.DEFAULT_OPACITY?(H=window.setTimeout(function(){na()},750),ga-=5):0<=ga-10?(kb(ga-10),H=window.setTimeout(function(){na()},40)):N.style.display=
"none")},B=a.Console,X=System;B.maxTotalLines=1E4;B.setMaxTotalLines=function(a){B.maxTotalLines=0<a?a:999999};B.maxLatency=40;B.setMaxLatency=function(a){B.maxLatency=0<a?a:40};B.pinning=!1;B.enablePinning=function(a){B.pinning=a};B.linesCount=0;B.metLineBreak=!1;B.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};var ca=String.fromCharCode(160),ca=ca+(ca+ca+ca);B.consoleOutput=function(a,
b){var c=window["j2s.lib"];(c=c&&c.console)&&"string"==typeof c&&(c=document.getElementById(c));if(!c)return!1;if(B.linesCount>B.maxTotalLines){for(var d=0;d<B.linesCount-B.maxTotalLines;d++)c&&0<c.childNodes.length&&c.removeChild(c.childNodes[0]);B.linesCount=B.maxTotalLines}var e=!1;a=("undefined"==typeof a?"":null==a?"null":""+a).replace(/\t/g,ca);if(0<a.length)switch(a.charAt(a.length-1)){case "\n":case "\r":a=1<a.length?a.substring(0,a.length-("\r"==a.charAt(a.length-2)?2:1)):"",e=!0}var h=null;
a=a.replace(/\t/g,ca);for(var h=a.split(/\r\n|\r|\n/g),d=0,k=h.length-1;d<=k;d++){var l=null;if(B.metLineBreak||0==B.linesCount||1>c.childNodes.length)l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",B.linesCount++;else try{l=c.childNodes[c.childNodes.length-1]}catch(m){l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",B.linesCount++}var q=document.createElement("SPAN");l.appendChild(q);q.style.whiteSpace="nowrap";b&&(q.style.color=b);l=h[d];
0==l.length&&(l=ca);q.appendChild(document.createTextNode(l));B.pinning||(c.scrollTop+=100);B.metLineBreak=d!=k||e}d=c.parentNode.className;!B.pinning&&(d&&-1!=d.indexOf("composite"))&&(c.parentNode.scrollTop=c.parentNode.scrollHeight);B.lastOutputTime=(new Date).getTime()};B.clear=function(){try{B.metLineBreak=!0;var a=window["j2s.lib"],b=a&&a.console;if(b&&(b=document.getElementById(b))){for(var c=b.childNodes,d=c.length;0<=--d;)b.removeChild(c[d]);B.linesCount=0}}catch(e){}};a.alert=function(a){B.consoleOutput(a+
"\r\n")};X.out.print=function(a){B.consoleOutput(a)};X.out.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};X.out.write=function(a,b,c){X.out.print(String.instantialize(a).substring(b,b+c))};X.err.__CLASS_NAME__="java.io.PrintStream";X.err.print=function(a){B.consoleOutput(a,"red")};X.err.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};X.err.write=function(a,b,c){X.err.print(String.instantialize(a).substring(b,
b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2022-03-11 11:09:21 -0600 (Fri, 11 Mar 2022) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.32.33";
