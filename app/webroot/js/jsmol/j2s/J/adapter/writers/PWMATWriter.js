...
Clazz.load (["J.api.JmolWriter"], "J.adapter.writers.PWMATWriter", ["java.lang.Float", "JU.P3", "$.PT", "JU.Logger"], function () {
...
this.bs = this.uc.removeDuplicates (this.vwr.ms, bs);
...
var f = "%4i%18.12p%18.12p%18.12p" + (cz == null ? "  1  1  1" : "%4i%4i%4i") + "\n";
...
this.oc.append (JU.PT.sprintf (f, "ipiii",  Clazz.newArray (-1, [Integer.$valueOf (a[i].getElementNumber ()), p, Integer.$valueOf (ix), Integer.$valueOf (iy), Integer.$valueOf (iz)])));
}}
