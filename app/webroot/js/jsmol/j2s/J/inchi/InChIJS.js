...
function (vwr, atoms, options) {
if (atoms == null || atoms.cardinality () == 0) return "";
var ret = "";
try {
if (options == null) options = "";
options = JU.PT.rep (JU.PT.rep (options.$replace ('-', ' '), "  ", " ").trim (), " ", " -");
if (options.length > 0) options = "-" + options;
var molData = vwr.getModelExtract (atoms, false, false, "MOL");
options = options.toLowerCase ();
if (options.length > 0) System.err.println ("JavaScript inchi.js options not implemented");
