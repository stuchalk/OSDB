...
if (Clazz_instanceOf (this.thisSection, String)) {
...
Clazz_defineMethod (c$, "colorSetting", 
 function (i) {
var pos = J.adapter.readers.pymol.PyMOLScene.listAt (this.settings, i);
...
var pt =  new JU.P3 ();
var pos = J.adapter.readers.pymol.PyMOLScene.listAt (this.settings, i);
if (pos != null && pos.size () == 3) return J.adapter.readers.pymol.PyMOLScene.pointAt (pos.get (2), 0, pt);
...
function (o) {
return (o == null ? 0 : Clazz_instanceOf (o, Integer) ? (o).intValue () : JU.CU.colorPtToFFRGB (J.adapter.readers.pymol.PyMOLScene.pointAt (o, 0, J.adapter.readers.pymol.PyMOLScene.ptTemp)));
}, "~O");
...
md.set (12290, null, null, strFormat, "angstroms", null, false, false, null, false, Clazz_floatToInt (rad * 2000), colix, text);
...
function (c) {
return J.adapter.readers.pymol.PyMOLScene.getColorPt (c.get (c.size () < 6 || J.adapter.readers.pymol.PyMOLScene.intAt (c, 4) == 0 ? 2 : 5));
}, "JU.Lst");
...
J.adapter.readers.pymol.PyMOL.addColor (c.get (1), isClamped ? J.adapter.readers.pymol.PyMOLScene.colorSettingClamped (c) : J.adapter.readers.pymol.PyMOLScene.getColorPt (c.get (2)));
}
}, "JU.Lst,~B");
...
var intReps = (bsReps == null ? J.adapter.readers.pymol.PyMOLReader.intAt (a, 20) : 0);
...
if (data[0] != 0) this.asc.setAnisoBorU (atom, data, 12);
