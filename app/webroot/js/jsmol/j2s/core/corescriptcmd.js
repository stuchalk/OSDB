...
var isAtoms = (!isQuaternion && strSmiles == null && !isPolyhedral || coordTo != null);
...
} else if (JU.PT.isOneOf (val.toLowerCase (), ";xyz;xyzrn;xyzvib;mol;mol67;sdf;v2000;v3000;json;pdb;pqr;cml;cif;cifp1;pwmat;qcjson;xsf;")) {
...
}if (!isImage && !isExport && !JU.PT.isOneOf (type, ";SCENE;JMOL;ZIP;ZIPALL;SPT;HISTORY;MO;NBO;ISOSURFACE;MESH;PMESH;PMB;ISOMESHBIN;ISOMESH;VAR;FILE;FUNCTION;CFI;CIF;CIFP1;CML;JSON;XYZ;XYZRN;XYZVIB;MENU;MOL;MOL67;PDB;PGRP;PQR;PWMAT;QUAT;RAMA;SDF;V2000;V3000;QCJSON;XSF;INLINE;")) eval.errorStr2 (54, "COORDS|FILE|FUNCTIONS|HISTORY|IMAGE|INLINE|ISOSURFACE|JMOL|MENU|MO|NBO|POINTGROUP|QUATERNION [w,x,y,z] [derivative]|RAMACHANDRAN|SPT|STATE|VAR x|ZIP|ZIPALL  CLIPBOARD", "CIF|CIFP1|CML|CFI|GIF|GIFT|JPG|JPG64|JMOL|JVXL|MESH|MOL|PDB|PMESH|PNG|PNGJ|PNGT|PPM|PQR|PWMAT|SDF|CD|JSON|QCJSON|V2000|V3000|SPT|XJVXL|XSF|XYZ|XYZRN|XYZVIB|ZIP" + driverList.toUpperCase ().$replace (';', '|'));
if (this.chk) return "";
...
zoffset = (hkl).w;
}oabc = this.getUVBoxFromHKL (u, hkl, plane);
var p =  new JU.P3 ();
var vt =  new JU.V3 ();
...
case 1073742138:
case 1073742163:
pt = (tok == 1073742138 ? eval.getPointOrPlane (++i, 3) : eval.checkHKL (eval.getFractionalPoint (++i)));
i = eval.iToken;
...
if (icell != 2147483647) {
this.vwr.ms.setUnitCellOffset (u, null, icell);
} else if (id != null) {
this.vwr.setCurrentCage (id);
} else if (isReset || oabc != null) {
isReset = true;
var unitCell = (doTransform ? u : null);
if (unitCell != null) {
var bsAtoms = null;
bsAtoms = this.vwr.getFrameAtoms ();
var fxyz = null;
...
for (var j = n; --j >= 0; ) {
fxyz[j] = JU.P3.newP (a[j]);
this.vwr.toFractionalUC (unitCell, fxyz[j], false);
}
...
}if (this.e.isPoint3f (this.e.iToken + 1)) pt = this.getPoint3f (++this.e.iToken, true);
...
break;
case 1275069441:
var na = this.vwr.getModelkit (false).cmdAssignAddAtoms (type, pt, bs, (isPacked ? "packed" : ""), this.e.fullCommand, isClick);
...
break;
case 4129:
bs.andNot (this.vwr.getMotionFixedAtoms ());
...
break;
case 134217764:
this.e.showString (this.vwr.getModelkit (false).cmdAssignSpaceGroup (bs, type));
break;
}
});
